#  Category Direction - Audit Events 
  ...
  5. Category Direction - Audit Events


The following page may contain information related to upcoming products, features and functionality. It is important to note that the information presented is for informational purposes only, so please do not rely on the information for purchasing or planning purposes. Just like with all projects, the items mentioned on the page are subject to change or delay, and the development, release, and timing of any products, features or functionality remain at the sole discretion of GitLab Inc. 
  * [Audit Events](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#audit-events)
    * [Overview](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#overview)
      * [Target Audience](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#target-audience)
    * [User pain points to address](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#user-pain-points-to-address)
      * [Thorough coverage of the actions that matter](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#thorough-coverage-of-the-actions-that-matter)
      * [Traceability](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#traceability)
      * [Flexibility in how to consume events](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#flexibility-in-how-to-consume-events)
      * [Actionability of results](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#actionability-of-results)
        * [Granularity](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#granularity)
        * [Simplicity](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#simplicity)
        * [Time savings](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#time-savings)
      * [What’s Next & Why](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#whats-next--why)
        * [How we will prioritize adding new audit events](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#how-we-will-prioritize-adding-new-audit-events)
      * [Feature authors should add their own audit events for features that are built](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#feature-authors-should-add-their-own-audit-events-for-features-that-are-built)
      * [What is Not Planned Right Now](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#what-is-not-planned-right-now)
      * [Maturity](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#maturity)
    * [User Success Metrics](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#user-success-metrics)
    * [Competitive landscape](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#competitive-landscape)
      * [GitHub Audit Logs](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#github-audit-logs)
      * [Azure DevOps Audit](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#azure-devops-audit)
      * [Bitbucket Auditing](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#bitbucket-auditing)
      * [Key Takeaways](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#key-takeaways)
    * [Analyst landscape](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#analyst-landscape)
    * [Top Customer Success/Sales issue(s)](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#top-customer-successsales-issues)
    * [Top Vision issue(s)](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#top-vision-issues)
  * [How you can help](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#how-you-can-help)


## Audit Events[](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#audit-events)
**Stage** | **Maturity** | **Content Last Reviewed**  
---|---|---  
[Software Supply Chain Security](https://about.gitlab.com/direction/software_supply_chain_security) | [Viable](https://about.gitlab.com/direction/#maturity) | `2022-03-04`  
### Overview[](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#overview)
...
Audit events are a necessary aspect of compliance, but more important is leveraging audit events to inform proactive decisions and actions. Every customer differs in their policies and procedures, but also in their security and compliance culture and mindset. It will be critical to provide customers with smart, proactive alerts about anomalous activity in a way that's easy to setup and take action on. Flexibility is key because some customers will want to take programmatic action (e.g. automatically block a user's account) and some will want to take a "lighter touch" approach (e.g. notify an administrator, but take no further action).
  * What success looks like: you should be able to define anomalous user behavior and GitLab's audit events should automatically flag activity matching that criteria. These definitions should be highly configurable and range from the simple to the complex. We are exploring this in [an epic](https://gitlab.com/groups/gitlab-org/-/epics/259).
...
As we add new audit events in the future, we will thoughtfully consider which to add first and which to add later. To help decide which events to add before others, we consider these priorities, in stack rank order, when deciding which events to focus on next:
  ...
  2. Events which alter configuration of settings or the permissions of users 
  ...
  3. Use of sensitive keys and tokens 
  ...
  4. Changes that cause data to be copied or exported to other sources 
  ...
  5. Workflow changes or cosmetic changes to a GitLab instance, group, or project 
...
Please note that the list above is not exhaustive, but shows a stack rank of some of the most important types of events to record and our perspective as we work on prioritizing them. The individual events we are working on are captured in [this epic](https://gitlab.com/groups/gitlab-org/-/epics/736) and we would love your feedback.
Note that when an action is taken very often, the audit events will likely generate more data than we can store. In those cases, we will deliver audit events for those actions as [streaming-only audit events](https://docs.gitlab.com/ee/administration/audit_event_streaming.html). This provides a good balance between recording the actions that users care about while not overwhelming GitLab servers with needing to store large amounts of data.
#### Feature authors should add their own audit events for features that are built[](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#feature-authors-should-add-their-own-audit-events-for-features-that-are-built)
...
Individual groups are responsible for adding audit events for their own features as they develop them. We maintain a self-service [development guide](https://docs.gitlab.com/ee/development/audit_event_guide/) in the documentation for how people can add a new audit event. If there are questions about the guide or about how to add an audit event for a specific feature, the Compliance group is happy to help.
#### What is Not Planned Right Now[](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#what-is-not-planned-right-now)
...
At this time, we do not intend to build a [full SIEM](https://en.wikipedia.org/wiki/Security_information_and_event_management) experience around Audit Events. A SIEM can do many different tasks and can consume many different data streams simultaneously, correlate them, and handle high data volumes. We envision audit events as being able to be consumed by an external SIEM, but we will not build a SIEM into GitLab itself.
We do not intend Audit Events to be used in such a way that they could be used for product analytics or measuring feature adoption. There are purpose-built tools, such as [GitLab Value Stream Management](https://about.gitlab.com/solutions/value-stream-management/) that can be used to understand how end-users use a product and measure adoption over time.
...
#### Maturity[](https://about.gitlab.com/direction/software_supply_chain_security/compliance/audit-events/#maturity)
Currently, GitLab’s maturity in Audit Events is **viable**. Here’s why: GitLab currently offers an audit log system, but it does not capture all of the required user-driven events. While we’re iterating and capturing more events over time, our users demand a comprehensive view of activity in application logs. However, the events being captured are useful at answering valuable questions on GitLab instances, and are [used to solve real problems](https://about.gitlab.com/direction/#maturity).
...
[Edit this page](https://gitlab.com/-/ide/project/gitlab-com/www-gitlab-com/edit/master/-/source/direction/software_supply_chain_security/compliance/audit-events/index.html.md) [View source](https://gitlab.com/gitlab-com/www-gitlab-com/blob/master/source/direction/software_supply_chain_security/compliance/audit-events/index.html.md)
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=5d8b0a8c77f548e88eadc0ccfbfc5a2b&_biz_l=https%3A%2F%2Fabout.gitlab.com%2Fdirection%2Fsoftware_supply_chain_security%2Fcompliance%2Faudit-events%2F&_biz_t=1773331812304&_biz_i=%0ACategory%20Direction%20-%20Audit%20Events%0A%7C%0AGitLab%0A&_biz_n=59&rnd=700461&cdn_o=a&_biz_z=1773331812467)
suggested results