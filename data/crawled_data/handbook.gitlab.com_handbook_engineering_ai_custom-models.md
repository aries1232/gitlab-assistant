...
## Vision[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#vision)
The Custom Models group focuses on additional, custom models that power GitLab Duo functionality in support of our customers unique data and use-cases.
## Organisation[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#organisation)
The AI-powered:Custom Models team focuses on GitLab’s suite of Custom Model features and is responsible for all backend aspects of the product categories that fall under the [Custom Models group](https://handbook.gitlab.com/handbook/product/categories/#custom-models-group) of the [AI Powered stage](https://handbook.gitlab.com/handbook/product/categories/#ai-powered-stage) of the [DevOps lifecycle](https://handbook.gitlab.com/handbook/product/categories/#devops-stages). Our Product direction is found on the [Category Direction - Custom Models Management](https://about.gitlab.com/direction/ai-powered/custom_models/) page.
The features we work with are listed on the [Features by Group Page](https://handbook.gitlab.com/handbook/product/categories/features/#custom-models).
### Team Members[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#team-members)
**Engineering Manager & Engineers**
Name | Role  
---|---  
[![Annie Ying](https://about.gitlab.com/images/gitlab-logo-extra-whitespace.png)Annie Ying](https://handbook.gitlab.com/handbook/company/team/#aying-gl) | [Manager, Engineering](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/)  
[![Bruno Cardoso](https://about.gitlab.com/images/team/bcardoso--crop.jpg)Bruno Cardoso](https://handbook.gitlab.com/handbook/company/team/#bcardoso-) |  [Senior ML Engineer](https://handbook.gitlab.com/job-families/engineering/development/data-science/machine-learning/), AI-powered:Custom Models  
[![Cindy Halim](https://about.gitlab.com/images/gitlab-logo-extra-whitespace.png)Cindy Halim](https://handbook.gitlab.com/handbook/company/team/#cindy-halim) | [Fullstack Engineer](https://handbook.gitlab.com/job-families/engineering/development/fullstack/)  
[![Patrick Cyiza](https://about.gitlab.com/images/team/jpcyiza-crop.jpg)Patrick Cyiza](https://handbook.gitlab.com/handbook/company/team/#jpcyiza) |  [Backend Engineer](https://handbook.gitlab.com/job-families/engineering/development/backend/), Create:Source Code  
[![Julie Huang](https://about.gitlab.com/images/team/juliehuang-crop.jpg)Julie Huang](https://handbook.gitlab.com/handbook/company/team/#julie_huang) | [Frontend Engineer](https://handbook.gitlab.com/job-families/engineering/development/frontend/intermediate/)  
[![Manoj Memana Jayakumar](https://about.gitlab.com/images/team/manojmj-crop.jpg)Manoj Memana Jayakumar](https://handbook.gitlab.com/handbook/company/team/#manojmj) |  [Staff Backend Engineer](https://handbook.gitlab.com/job-families/engineering/development/backend/), AI-Powered:Custom Models  
[![Mohamed Hamda](https://about.gitlab.com/images/team/mohamedhamda-crop.jpg)Mohamed Hamda](https://handbook.gitlab.com/handbook/company/team/#mhamda) | [Backend Engineer, AI-Powered:Custom Models](https://handbook.gitlab.com/job-families/engineering/development/backend/intermediate/)  
[![Newvick Lee](https://about.gitlab.com/images/team/newvicklee-crop.jpg)Newvick Lee](https://handbook.gitlab.com/handbook/company/team/#nlee8) |  [Backend Engineer](https://handbook.gitlab.com/job-families/engineering/backend-engineer/), AI-Powered:Custom Models  
**Stable Counterparts**
The following members of other functional teams are our stable counterparts:
**Name** | **Role**  
---|---  
[Jordan Janes](https://handbook.gitlab.com/handbook/company/team/#jordanjanes) | [Principal Product Manager](https://handbook.gitlab.com/job-description-library/product/product-manager/)  
### How to reach us[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#how-to-reach-us)
...
#### Organisational Labels[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#organisational-labels)
...
## Scoping Work using Epics and Tech Leads[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#scoping-work-using-epics-and-tech-leads)
...
## Team Milestone Planning Process[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#team-milestone-planning-process)
Custom Models follows the [Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/) and [Cross Functional Prioritization](https://handbook.gitlab.com/handbook/engineering/workflow/cross-functional-prioritization/). The team uses a planning issue and boards to manage the planning process. [Planning automation](https://gitlab.com/gitlab-org/ai-powered/custom-models/custom-models/-/blob/main/doc/planning/index.md) scripts are available to make this process easier. [Planning issues](https://gitlab.com/groups/gitlab-org/-/epics/13440) for each milestone are created by the PM and are used to coordinate upcoming work between the PM, EM and stable counterparts.
...
### Planning Issue[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#planning-issue)
...
### Planning Board[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#planning-board)
...
### Automation for Issue Refinement[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#automation-for-issue-refinement)
...
Engineers refine issues weekly by reviewing tasks, estimating their complexity, and preparing them for development. During the refinement process, they evaluate the work required, add implementation plans when needed, add a [weight](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#issue-weights), and mark issues as [ready for development](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#ready-for-development-status). This process ensures issues are well-defined before development begins.
### Ready for Development Status[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#ready-for-development-status)
...
### Capacity Planning Spreadsheet[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#capacity-planning-spreadsheet)
...
### Build Board[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#build-board)
The EM selects issues from the [Planning Board](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#planning-board) based on:
...
### Say / Do Ratio[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#say--do-ratio)
...
### Issue Weights[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#issue-weights)
...
### Planning and Delivery Boards[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#planning-and-delivery-boards)
All workflow statuses in the [Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/) are valid, and the statuses and milestones tied to boards are below.
...
### Issue Milestones[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#issue-milestones)
...
## Blog Posts[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#blog-posts)
...
## Communication[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#communication)
The Custom Models communicates based on the following guidelines:
  1. Always prefer async communication over sync meetings.
  2. Don’t shy away from arranging a [sync call](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#ad-hoc-sync-calls) when async is proving inefficient, however endevour record it to share with team members.
  3. [Transparency by Default](https://handbook.gitlab.com/handbook/security/transparency-by-default/)
  4. The primary channel for work-related communication is the [#g_custom_models](https://gitlab.enterprise.slack.com/archives/C06DCB3N96F) Slack channel.
  5. Internal team issues and projects are namespaced under [`gitlab-org/ai-powered/custom-models`](https://gitlab.com/gitlab-org/ai-powered/custom-models)


## LLM Judges[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#llm-judges)
...
## Asking for help[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#asking-for-help)
...
## Customer support[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#customer-support)
To better support calls with customers (existing and prospects), Custom Models provides engineers that will prioritize customer support requests. This ensures both load and knowledge are shared across team members.
During on call period, support requests should be acknowledge within 24h.
### Responsibilities of lead engineer in support[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#responsibilities-of-lead-engineer-in-support)
  ...
  * Act on outcomes of problems faced: 
    ...
    2. Could the issue be improved by better tooling? Create an issue with the changes needed.
    3. Was it a bug that we didn’t caught? How can we avoid this the next time?
...
### Responsibilities of backup engineers[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#responsibilities-of-backup-engineers)
...
## Acknowledgement of Pings[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#acknowledgement-of-pings)
If you are pinged by name in either Slack or GitLab, please acknowledge the ping by either:
  * A threaded comment
  * An emoji


## Time Off[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#time-off)
Team members should add any [Paid Time Off](https://handbook.gitlab.com/handbook/people-group/time-off-and-absence/time-off-types/) in the “Workday” slack app, so that the Engineering Manager can use the proper number of days off during capacity planning. Where possible, try to add time off a full milestone in advance.
...
## Ad-hoc sync calls[](https://handbook.gitlab.com/handbook/engineering/ai/custom-models/#ad-hoc-sync-calls)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/ai/custom-models/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/ai/custom-models/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)