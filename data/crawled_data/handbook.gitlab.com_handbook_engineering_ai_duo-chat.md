...
## 🚀 Team Members[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#-team-members)
**Engineering Manager & Engineers**
Name | Role  
---|---  
[![Juan Silva](https://about.gitlab.com/images/team/juansilva-crop.jpg)Juan Silva](https://handbook.gitlab.com/handbook/company/team/#juan-silva) | [Engineering Manager, AI-Powered:Duo Chat](https://handbook.gitlab.com/job-families/engineering/development/management/engineering-manager/)  
[![Dillon Wheeler](https://about.gitlab.com/images/team/dillonwheeler-crop.jpg)Dillon Wheeler](https://handbook.gitlab.com/handbook/company/team/#dillonwheeler) | [Backend Engineer, AI-powered:Duo Chat](https://handbook.gitlab.com/job-families/engineering/development/backend/)  
[![Eva Kadlecová](https://about.gitlab.com/images/team/evakadlecova-crop.jpg)Eva Kadlecová](https://handbook.gitlab.com/handbook/company/team/#evakadlecova) | [Backend Engineer, AI-powered:Duo Chat](https://handbook.gitlab.com/job-families/engineering/development/backend/)  
[![Senior Backend Engineer](https://about.gitlab.com/images/team/jfypk-crop.jpg)Senior Backend Engineer](https://handbook.gitlab.com/handbook/company/team/#jfypk) | [Backend Engineer, AI-powered:Duo Workflow](https://handbook.gitlab.com/job-families/engineering/development/backend/)  
[![Kaveh Nejad](https://about.gitlab.com/images/team/kavehnejad-crop.jpg)Kaveh Nejad](https://handbook.gitlab.com/handbook/company/team/#kaveh_nejad_gitlab) | [Backend Engineer](https://handbook.gitlab.com/job-families/engineering/backend-engineer/)  
[![Mark Chao](https://about.gitlab.com/images/team/markchao-crop.jpg)Mark Chao](https://handbook.gitlab.com/handbook/company/team/#lulalala) | [Senior Backend Engineer, AI-powered:Duo Chat](https://handbook.gitlab.com/job-families/engineering/development/backend/)  
[![Shinya Maeda](https://about.gitlab.com/images/team/shinya-crop.jpg)Shinya Maeda](https://handbook.gitlab.com/handbook/company/team/#shinyamaeda) |  [Staff Backend Engineer](https://handbook.gitlab.com/job-families/engineering/development/backend/), AI-powered:Duo Chat  
[![Tetiana Chupryna](https://about.gitlab.com/images/team/tetianachupryna-crop.jpg)Tetiana Chupryna](https://handbook.gitlab.com/handbook/company/team/#brytannia) | [Senior Backend Engineer, AI-powered:Duo Chat](https://handbook.gitlab.com/job-families/engineering/development/backend/)  
[![Tomáš Bulva](https://about.gitlab.com/images/team/tbulva-crop.jpg)Tomáš Bulva](https://handbook.gitlab.com/handbook/company/team/#tbulva) | [Senior Frontend Engineer, Global Search](https://handbook.gitlab.com/job-families/engineering/development/frontend/)  
**Product, Design & Quality**
Name | Role  
---|---  
[![Enrique Alcántara](https://about.gitlab.com/images/team/enrique-alcantara-crop.jpg)Enrique Alcántara](https://handbook.gitlab.com/handbook/company/team/#ealcantara) | [Staff Frontend Engineer, AI-powered:Duo Chat](https://handbook.gitlab.com/job-families/engineering/development/frontend/)  
## Vision[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#vision)
...
### Technical Strategy[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#technical-strategy)
As our team is developing an LLM-driven Chat application to enhance interactions within the GitLab DevSecOps platform, our technical strategy is focused on estabilishing the key engineering aspects that will ensure its reliability, scalability, and effectiveness. We will expose this through guidelines and tools so contributing teams can benefit. Please see our [Technical Strategy](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/technical-strategy/) page for full details.
## 📚 Internal Processes[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#-internal-processes)
### Host Systems[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#host-systems)
...
### Ownership and Maintenance of DuoChat Integrations[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#ownership-and-maintenance-of-duochat-integrations)
...
#### Responsibilities[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#responsibilities)
...
#### Tools[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#tools)
...
### UX Reviews[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#ux-reviews)
...
### Planning Process[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#planning-process)
This flowchart describes the planning process for the Duo Chat team:
![Duo Chat Planning Flowchart](https://handbook.gitlab.com/images/duo_chat_planning_flowchart.png)
...
### Issue Estimation[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#issue-estimation)
This system should be used when estimating tasks, _inspired_ by the former Foundations team’s weighting system.
...
## Troubleshooting Duo Chat[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#troubleshooting-duo-chat)
...
## How to Ask for Support From Duo Chat[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#how-to-ask-for-support-from-duo-chat)
...
### Before requesting help[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#before-requesting-help)
...
### Asking a general question[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#asking-a-general-question)
If you have a general question for which you can’t find your answer, then feel free to ask your question in the _#g_duo_chat_ channel on Slack. In this channel, there are numerous stakeholders with an ample breadth of knowledge about Duo Chat’s usage and capabilities.
...
### Submitting a bug[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#submitting-a-bug)
...
### Create a support request issue[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#create-a-support-request-issue)
...
Alternatively, if you know that you have a complex request, you may want to save time by opening the issue directly and then ping the team in Slack with the link. You may assign a priority label to your request. A Duo Chat team member or the PM will review this priority assignment during the triage of the issue. Please use the table below as a reference of priority levels and expected response times.
...
## 🔗 Other Useful Links[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#-other-useful-links)
### 📝 Dashboards (internal only)[](https://handbook.gitlab.com/handbook/engineering/ai/duo-chat/#-dashboards-internal-only)
  ...
  * [Duo Chat Error Rate in Elastic](https://log.gprd.gitlab.net/app/dashboards#/view/5f334d60-cfd7-11ee-bc6b-0b206b291ea1?_g=%28refreshInterval:%28pause:!t,value:60000%29,time:%28from:now-2d,to:now%29%29)
...
A detailed description of the pillars of technical strategy for the Duo Chat group
