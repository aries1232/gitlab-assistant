...
## Engineering IC Leadership at GitLab: going beyond Senior level[](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#engineering-ic-leadership-at-gitlab-going-beyond-senior-level)
At GitLab, it is expected that everyone is [a manager of one](https://handbook.gitlab.com/handbook/leadership/#managers-of-one). For Individual Contributors (IC) a new type of challenge begins with the Staff Engineer role. Engineering IC Leadership is an alternative [career path](https://handbook.gitlab.com/handbook/engineering/careers/#roles) to Engineering Management.
...
Engineering IC Leaders exert [technical leverage](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#technical-leverage) in their [scope of influence](https://handbook.gitlab.com/handbook/engineering/careers/matrix/). Like any other leadership role, the focus should be on helping others to improve. Their impact multiplies with every person they help grow, and the company gets more value when they’re not investing time in doing things themselves.
...
### What GitLab Engineers Have to Say About IC Leadership[](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#what-gitlab-engineers-have-to-say-about-ic-leadership)
...
### Technical Leverage[](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#technical-leverage)
...
Examples of this are:
  * Taking part in our [architecture process](https://handbook.gitlab.com/handbook/engineering/architecture/workflow/)
...
### The four archetypes[](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#the-four-archetypes)
Staff Engineers and Engineering Managers shared their perspective on [what does Staff level mean at GitLab](https://about.gitlab.com/blog/2020/02/18/staff-level-engineering-at-gitlab/) in an Unfiltered blog post. Much of what each engineer said overlapped, but each had a unique perspective based on their team and their particular experience within GitLab as an entity.
...
### The four archetypes at GitLab[](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#the-four-archetypes-at-gitlab)
...
#### Tech Lead[](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#tech-lead)
The most common archetype for a new Staff Engineer is the Tech Lead, as a Senior Engineer may start showing Staff level behaviors emerging from their team. At GitLab, this is not only an archetype but also a role assigned to engineers on per-project basis. Read more about this on a dedicated [Tech Lead Handbook page](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/tech-lead/).
...
#### Architect[](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#architect)
At GitLab [Architecture is a practice](https://handbook.gitlab.com/handbook/engineering/architecture/) where [everyone can contribute](https://handbook.gitlab.com/handbook/company/mission/#mission) but Staff+ Engineers play a fundamental role in that.
...
#### Solver[](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#solver)
...
[Other teams may need a Staff+ Engineer on loan](https://handbook.gitlab.com/handbook/engineering/careers/#team-members-on-loan-to-another-team). The receiving team may or may not already have a Staff+ Engineer, a Solver deals with the problem at hand, and makes sure the team is empowered to take care of the work once the complexity level is manageable.
#### Right Hand[](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/#right-hand)
One of the conclusions from our work on [Architecture Practice at GitLab](https://handbook.gitlab.com/handbook/engineering/architecture/) is that introducing complex architectural changes can not happen without Staff+ ICs working closely with the decision-makers. This conclusion highlights the need for a close collaboration between Engineering Manager+ and Staff+ Engineers, and it fits very well into the Right Hand archetype definition.
...
* * *
#####  [Tech Lead at GitLab](https://handbook.gitlab.com/handbook/engineering/careers/ic-leadership/tech-lead/)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/careers/ic-leadership/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/careers/ic-leadership/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)