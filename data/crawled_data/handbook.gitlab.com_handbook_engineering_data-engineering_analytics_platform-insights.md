# Analytics:Platform Insights Group
## Who we are?[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#who-we-are)
The Platform Insights group is part of the GitLab [Analytics Stage](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/) and builds [GitLab Observability](https://about.gitlab.com/direction/monitor/platform-insights/) and [Product Analytics](https://about.gitlab.com/direction/monitor/platform-insights/) products.
### Team members[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#team-members)
Name | Role  
---|---  
### Stable counterparts[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#stable-counterparts)
Name | Role  
---|---  
[![Principal Engineer](https://about.gitlab.com/images/team/adamhegyi-crop.jpg)Principal Engineer](https://handbook.gitlab.com/handbook/company/team/#ahegyi) |  [Principal Engineer](https://handbook.gitlab.com/job-families/engineering/development/management/principal-engineer/), Monitor  
[![Lindsy Farina](https://about.gitlab.com/images/team/lindsyfarina-crop.jpg)Lindsy Farina](https://handbook.gitlab.com/handbook/company/team/#lfarina8) |  [Senior Product Manager](https://handbook.gitlab.com/job-families/product/product-manager/#senior-product-manager/), Monitor:Platform Insights  
## Technical Architecture[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#technical-architecture)
### Architecture Blueprints[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#architecture-blueprints)
...
### Architecture Documentation[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#architecture-documentation)
  * See [this page](https://gitlab.com/gitlab-org/opstrace/opstrace/-/tree/main/docs/architecture)


### Project Links[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#project-links)
...
### ClickHouse Datastore[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#clickhouse-datastore)
...
## How we work?[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#how-we-work)
We base our workflow on the company’s [Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/). Any modifications or clarifications on how we apply the workflow are detailed below.
### Async Standups[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#async-standups)
...
### Async Updates[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#async-updates)
Every Friday, the EM provides an async update of the team’s progress.
...
### Meetings[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#meetings)
...
### Communication[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#communication)
...
### How we do planning?[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#how-we-do-planning)
...
### Issue prioritization[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#issue-prioritization)
...
### How to find something to work on?[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#how-to-find-something-to-work-on)
...
### How to enable Observability Beta for a customer?[](https://handbook.gitlab.com/handbook/engineering/data-engineering/analytics/platform-insights/#how-to-enable-observability-beta-for-a-customer)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/data-engineering/analytics/platform-insights.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/data-engineering/analytics/platform-insights.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)