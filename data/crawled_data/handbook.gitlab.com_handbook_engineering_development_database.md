...
Also see [Database Team](https://handbook.gitlab.com/handbook/engineering/data-engineering/database-excellence/database-frameworks/) in Enablement.
## GitLab development[](https://handbook.gitlab.com/handbook/engineering/development/database/#gitlab-development)
...
### Database Roles at GitLab[](https://handbook.gitlab.com/handbook/engineering/development/database/#database-roles-at-gitlab)
We have two primary job roles that are focused on the database aspect:
  1. [Backend Engineer, Database](https://handbook.gitlab.com/job-description-library/engineering/backend-engineer/) - in Development
  2. [Database Reliability Engineer](https://handbook.gitlab.com/job-description-library/engineering/infrastructure/database-reliability-engineer/) - in Infrastructure
...
#### Database Maintainer[](https://handbook.gitlab.com/handbook/engineering/development/database/#database-maintainer)
...
The Database Maintainer role:
  ...
  * Follows the same definition as any other [GitLab maintainer](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainer).
  * It does not come with operational responsibility for GitLab.com and its database infrastructure. This responsibility belongs to the [Database Reliability Engineer](https://handbook.gitlab.com/job-description-library/engineering/infrastructure/database-reliability-engineer/).
...
If you’re interested in participating in database reviews, please start by reviewing [the Database maintainer process](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-database) which contains all the resources for a reviewer.
## Recommended links and reference materials[](https://handbook.gitlab.com/handbook/engineering/development/database/#recommended-links-and-reference-materials)
### GitLab resources[](https://handbook.gitlab.com/handbook/engineering/development/database/#gitlab-resources)
  * Database Office Hours are bi-weekly and can be found on the [GitLab Team Meetings Calendar](https://handbook.gitlab.com/handbook/tools-and-tips/#gitlab-team-meetings-calendar)
...
### Books[](https://handbook.gitlab.com/handbook/engineering/development/database/#books)
...
### Other resources[](https://handbook.gitlab.com/handbook/engineering/development/database/#other-resources)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/development/database.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/development/database.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)