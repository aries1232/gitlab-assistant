...
The Fulfillment Sub-department is composed of the Billing and Subscription Management, Fulfillment Platform, Provision, and Utilization development teams working on the infrastructure between the systems which affect the user purchasing process that support the GitLab DevOps Platform.
  ...
  * [Team](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#team-members)


## Vision[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#vision)
A [high performing team](https://handbook.gitlab.com/handbook/leadership/#strategies-to-build-high-performing-teams) who provides our customers with a world-class buyer experience through the products we build. Our team strives to build an experience that is delightful, performant, trustworthy, and reliable.
## Mission[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#mission)
Fulfillment focuses on improving our capabilities and metrics in the following areas:
  * [Platform](https://handbook.gitlab.com/handbook/product/categories/#fulfillment-platform-group): [Team](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/fulfillment-platform/#team-members)
  * [Provision](https://handbook.gitlab.com/handbook/product/categories/#provision-group): [Team](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/provision/#team-members)
  * [Seat Management](https://handbook.gitlab.com/handbook/product/categories/#seat-management-group): [Team](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/seat-management/#team-members)
  * [Subscription Management](https://handbook.gitlab.com/handbook/product/categories/#subscription-management-group): [Features](https://about.gitlab.com/direction/fulfillment/subscription-management/#key-focus-areas)
  * [Utilization](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/utilization/): [Team](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/utilization/#team-members)


## Direction[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#direction)
...
## Team members[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#team-members)
...
## Stable counterparts[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#stable-counterparts)
### Sales & Go-To-Market[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#sales--go-to-market)
Name | Role  
---|---  
[![Carli Nodari](https://about.gitlab.com/images/gitlab-logo-extra-whitespace.png)Carli Nodari](https://handbook.gitlab.com/handbook/company/team/#cnodari) | [Senior Director, Deal Desk](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/)  
[![Jesse Rabbits](https://about.gitlab.com/images/team/jrabbits2-crop.jpg)Jesse Rabbits](https://handbook.gitlab.com/handbook/company/team/#jrabbits) | [Sr. Manager, Deal Desk](https://handbook.gitlab.com/job-families/sales/deal-desk/#senior-manager-deal-desk)  
[![Gurmee Sodhi](https://about.gitlab.com/images/team/gurmeesodhi-crop.jpg)Gurmee Sodhi](https://handbook.gitlab.com/handbook/company/team/#gsodhi) | [Senior Analyst, Online Sales & Self Service Product GTM](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/)  
### Finance & IT[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#finance--it)
Name | Role  
---|---  
[![Anna Piaseczna](https://about.gitlab.com/images/team/annapiaseczna-crop.jpg)Anna Piaseczna](https://handbook.gitlab.com/handbook/company/team/#annapiaseczna) | [Analytics Engineer](https://handbook.gitlab.com/job-families/finance/analytics-engineer/)  
### Support Engineering[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#support-engineering)
Name | Role  
---|---  
[![John Lyttle](https://about.gitlab.com/images/team/john_lyttle-crop.jpg)John Lyttle](https://handbook.gitlab.com/handbook/company/team/#jlyttle) | [Manager, Support Engineering](https://handbook.gitlab.com/job-families/engineering/support-management/)  
[![Ket Slaats](https://about.gitlab.com/images/team/ketslaats-crop.jpg)Ket Slaats](https://handbook.gitlab.com/handbook/company/team/#kslaats) | [Manager, Support Engineering (APAC)](https://handbook.gitlab.com/job-families/engineering/support-management/)  
### Office of the CEO[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#office-of-the-ceo)
### Product Technical Program Management[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#product-technical-program-management)
Name | Role  
---|---  
[![Clarissa Ersoz](https://about.gitlab.com/images/gitlab-logo-extra-whitespace.png)Clarissa Ersoz](https://handbook.gitlab.com/handbook/company/team/#cersoz) | [Technical Program Manager](https://handbook.gitlab.com/job-families/product/program-manager/)  
## Project management process[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#project-management-process)
  * In accordance with our [GitLab values](https://handbook.gitlab.com/handbook/values/)
  * Transparently: nearly everything is public, we record/livestream meetings whenever possible
  * We get a chance to work on the things we want to work on
  * Everyone can contribute; no silos


### SAFE[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#safe)
...
### Planning[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#planning)
We plan in monthly cycles in accordance with our [Product Development Timeline](https://handbook.gitlab.com/handbook/engineering/workflow/#product-development-timeline). Release scope for an upcoming release should be finalized by the `1st`.
...
### Intake Request[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#intake-request)
...
We strictly adhere to this Intake Request process to ensure we capture the full details of a request before actioning on it. Once our Product Managers receive this request, we’ll work with the requestor to ensure we have a full understanding of the problem and requirements. After this, we will [prioritize](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#prioritization) your request.
### Prioritization[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#prioritization)
We follow our [prioritization framework](https://handbook.gitlab.com/handbook/product/product-processes/#prioritization) including [cross-functional prioritization guidelines](https://handbook.gitlab.com/handbook/product/product-processes/cross-functional-prioritization/) to prioritize our backlog on a monthly basis. R&D teams use a variety of inputs and sensing mechanisms, including SLAs, OKRs, [L&R Support Priority Issues list for Fulfillment](https://handbook.gitlab.com/handbook/support/license-and-renewals/workflows/managing_product_issues/#supports-issue-list-for-fulfillment), technical debt, and more to set priorities.
...
For our monthly milestone planning at the group level, we optimize activities to align with our OKRs, remaining flexible and allowing deviations from the 60/40 split. We also make sure to complete within SLA any forced prioritization, as necessary, per our [prioritization framework](https://handbook.gitlab.com/handbook/product/product-processes/#prioritization-framework).
Every team uses the [monthly prioritization template](https://gitlab.com/gitlab-org/fulfillment-meta/-/blob/master/.gitlab/issue_templates/monthly-prioritization.md) for [cross-functional dashboard reviews](https://handbook.gitlab.com/handbook/engineering/development/#cross-functional-dashboard-reviews) every month.
### Estimation[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#estimation)
...
In planning and estimation, we value [velocity over predictability](https://handbook.gitlab.com/handbook/engineering/development/principles/#velocity). The main goal of our planning and estimation is to focus on the [MVC](https://handbook.gitlab.com/handbook/values/#minimal-valuable-change-mvc), uncover blind spots, and help us achieve a baseline level of predictability without over optimizing. In general departments at GitLab aim for [70% predictability] but in the Fulfillment sub-department we aim for 80% predictability since our work is typically cross-functional and we need to be in lockstep with other departments.
  * If an issue has many unknowns where it’s unclear if it’s a 1 or a 5, we will be cautious and estimate high (5).
  * If an issue has many unknowns, we can break it into two issues. The first issue is for research, also referred to as a [Spike](https://en.wikipedia.org/wiki/Spike_%28software_development%29), where we de-risk the unknowns and explore potential solutions. The second issue is for the implementation.
...
### Picking something to work on[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#picking-something-to-work-on)
Engineers can find and open [their team’s planning issue to check their milestone board](https://gitlab.com/gitlab-org/fulfillment-meta/-/issues/?sort=priority_desc&state=opened&label_name%5B%5D=Planning%20Issue&first_page_size=100) and begin working first on those with the `deliverable` label.
...
### Workflow[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#workflow)
We generally follow the [Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/#workflow-summary) and use the workflow labels as defined there.
...
While individual groups are free to use as many stages in the [Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/#workflow-summary) workflow as they find useful, we should be somewhat prescriptive on how issues transition from discovery/refinement to implementation.
### User Experience[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#user-experience)
...
#### How we work[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#how-we-work)
  * We follow the [Product Designer workflows](https://handbook.gitlab.com/handbook/product/ux/product-designer/) and [UX Researcher workflows](https://handbook.gitlab.com/handbook/product/ux/experience-research/) described in the [Product Design section](https://handbook.gitlab.com/handbook/product/ux/) of the handbook.
  * We measure our progress using [UX Scorecards](https://handbook.gitlab.com/handbook/product/ux/ux-scorecards/).
  * We prioritize the most important projects every quarter, and Fulfillment product designers [support projects instead of Groups](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#product-designer-focus-areas).
  * We use [[UX] issues](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#ux-issue-management-and-weights) as the SSOT for designs. Implementation issues should link to the [UX] issue for the design details to maintain the SSOT.
  * We use labels to track our issues: 
    * `UX`, `devops::fulfillment`, `section::fulfillment` and `group::`.
    * `workflow::` labels to indicate where the issue is in the [product development flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/)
    * `UX Problem Validation` and `UX Solution Validation` for research efforts
    * `design weight::` for UX issue weights


#### Product Designer focus areas[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#product-designer-focus-areas)
...
Best practices
  ...
  * Product Designers should be assigned [UX MR reviews](https://handbook.gitlab.com/handbook/product/ux/product-designer/mr-reviews/) for the projects they’re supporting. 
...
#### UX issue management and weights[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#ux-issue-management-and-weights)
...
### Approving and merging the work[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#approving-and-merging-the-work)
...
In addition to the approval rules, MRs may require additional reviews as suggested by the [Danger bot](https://docs.gitlab.com/ee/development/dangerbot.html):
  ...
  2. Security-related issues (such as changes to authentication) require a [Security review](https://handbook.gitlab.com/handbook/security/product-security/security-platforms-architecture/application-security/appsec-reviews/#adding-features-to-the-queue--requesting-a-security-review)
  3. Changes to the SFDC APIs require review by the [Sales team](https://handbook.gitlab.com/handbook/sales/field-operations/sales-systems/)
  4. Changes to the Zuora APIs require review by the [EntApps team](https://handbook.gitlab.com/handbook/business-technology/enterprise-applications/)
  5. Changes to the user experience require a [UX Review](https://handbook.gitlab.com/handbook/product/ux/product-designer/mr-reviews/).


### Weekly async issue updates[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#weekly-async-issue-updates)
...
### Async projects update[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#async-projects-update)
...
### Demos[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#demos)
...
### Quality[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#quality)
GitLab’s Quality is everyone’s responsibility.
#### End-to-end tests - how, when and why to write them[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#end-to-end-tests---how-when-and-why-to-write-them)
...
#### GitLab[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#gitlab)
...
#### CustomersDot[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#customersdot)
...
### Testing[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#testing)
The CustomersDot has different types of tests running:
  ...
  4. Frontend tests
  5. E2E integration tests [via Watir](https://github.com/watir/watir)
...
When in doubt, err on the side of rejecting access as it can be easily restored through another [access request](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/).
### Deployment[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#deployment)
#### Revenue impacting changes[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#revenue-impacting-changes)
...
#### CustomersDot[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#customersdot-1)
...
Merged
Staging
E2E Test on Staging in 40 minutes
Verification
Auto deploy to production in 3 hours
...
#### Feature freeze[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#feature-freeze)
...
#### Production Change Lock (PCL)[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#production-change-lock-pcl)
There are times when GitLab temporarily halts production changes during certain events such as major global holidays, and other times where GitLab Team Member availability is substantially reduced. More information about PCLs can be found in [this infrastructure handbook page](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/change-management/#production-change-lock-pcl).
...
##### Zuora Blocked Period[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#zuora-blocked-period)
Zuora follows a [release calendar](https://handbook.gitlab.com/handbook/business-technology/enterprise-applications/pmo/#release-calendar) with blocked periods where Change Requests may not be possible or require additional approvals.
### Incident management[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#incident-management)
On going [Fulfillment Platform](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/fulfillment-platform/) work will provide greater observability to all of the Fulfillment systems. In the meantime, however, we have some tools like [CustomersDot health](https://customersdot.cloudwatch.net/) that post to [#s_fulfillment_status](https://gitlab.slack.com/archives/CL7SX4N86) in Slack. On occasion, there are reports of systemic critical trouble like a liveliness probe check failure, invalid SSL certificate, or other application errors. Look to the following sub-sections below for ways that you can contribute to error resolution.
See this handbook page for more information on [GitLab Monitoring](https://handbook.gitlab.com/handbook/engineering/monitoring/) and [Incident Management](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/incident-management/).
#### Escalation process for incidents or outages[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#escalation-process-for-incidents-or-outages)
...
**When Tier 2 gets paged:**
  ...
  * The Tier 2 SME rotation follows a [defined escalation path](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/incident-management/on-call/tier-2/): 
...
**General incident reporting:**
  1. When an outage occurs, the [SRE on-call](https://handbook.gitlab.com/handbook/engineering/on-call/) is notified automatically. Incidents can also be [reported manually](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/incident-management/#reporting-an-incident).
  2. When required, the SRE on-call or incident reporter can ping `@fulfillment-engineering` on Slack to notify and get help from the team


#### Escalation process for urgent issues[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#escalation-process-for-urgent-issues)
In most cases an MR should follow the standard process of review, maintainer review, merge, and deployment as outlined above. When production is broken:
  1. First determine whether the [Rapid Engineering Response](https://handbook.gitlab.com/handbook/engineering/workflow/#rapid-engineering-response) process should be followed. This will depend on availability and how critical the situation is.
  ...
  3. When there are no project maintainers available ([CustomersDot](https://handbook.gitlab.com/handbook/engineering/projects/#customers-app)) an additional GitLab Team Member with Maintainer access can be asked to assist.


In these cases please ensure:
  1. There is an issue describing the reasons for the escalation, as per the [Rapid Engineering Response](https://handbook.gitlab.com/handbook/engineering/workflow/#rapid-engineering-response). Consider ‘@‘mentioning the relevant [Growth/Fulfillment teams](https://gitlab.com/gitlab-org/growth).
  2. The change is announced on the [#s_fulfillment](https://gitlab.slack.com/archives/CMJ8JR0RH) channel.


#### Investigation[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#investigation)
  ...
  * You can query logs in [Kibana / Elasticsearch](https://log.gprd.gitlab.net/). Use this link to read more on using [kibana at GitLab](https://handbook.gitlab.com/handbook/support/workflows/kibana/))
...
#### Declaring incidents[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#declaring-incidents)
[Raising an incident](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/incident-management/#report-an-incident-via-slack) is always an option if you need immediate attention on a blocking problem.
...
#### Grafana dashboards[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#grafana-dashboards)
...
### Customer escalations[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#customer-escalations)
If there is a licensing issue (from support or sales) that requires escalation to product management or engineering, please create an issue via the process documented on the [support handbook page](https://handbook.gitlab.com/handbook/support/internal-support/#regarding-licensing-and-subscriptions) under `Assistance with License Issue`. Please do this instead of escalating in Slack or other methods.
...
### Retrospectives[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#retrospectives)
#### Monthly retrospectives[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#monthly-retrospectives)
After the `8th`, the Fulfillment team conducts an [asynchronous retrospective](https://handbook.gitlab.com/handbook/engineering/careers/management/group-retrospectives/). You can find current and past retrospectives for Fulfillment in <https://gitlab.com/gl-retrospectives/fulfillment/issues/>.
##### Retrospective Contributions[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#retrospective-contributions)
Everyone is encouraged to participate in asynchronous retrospective issues. This is a safe space for team member feedback. You are welcome, however, to bring your comments and concerns to the synchronous retrospective discussion or share them with your manager or other department leadership as well. We follow [this guidance](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/engineering/management/group-retrospectives/) to produce an efficient and safe retrospective.
...
##### Asynchronous Retrospective Synchronous Discussion[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#asynchronous-retrospective-synchronous-discussion)
...
#### Iteration retrospectives[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#iteration-retrospectives)
There are several resources at GitLab for improving our iteration capability:
  * [engineering iteration documentation](https://handbook.gitlab.com/handbook/engineering/workflow/iteration/)
  * [product iteration documentation](https://handbook.gitlab.com/handbook/product/product-principles/#iteration)
  * [self-guided iteration training issue](https://gitlab.com/gitlab-com/Product/-/issues/new?issuable_template=iteration-training)
  * [iteration office hours](https://handbook.gitlab.com/handbook/ceo/#iteration-office-hours)
  * [milestone retrospectives](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#retrospectives)
  * [iteration retrospectives](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#iteration-retrospectives)


Agile software development practices uses the phrase `Iteration Retrospective` to describe what we perform during our [Milestone Retrospective](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#retrospectives). While the Milestone Retrospective is essential in understanding how we can improve, it does have a broad focus across multiple teams. It’s a safe space where everyone can contribute through reflection on what we can continue, what we can correct, and what we can improve.
...
Review [these rules](https://handbook.gitlab.com/handbook/engineering/careers/management/group-retrospectives/) for an effective retrospective.
**Participation**
...
### Project Cadence[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#project-cadence)
This table lists recurring activities that are part of our Project Management Process. Having a well defined cadence makes it simple for our team to understand what activities are happening and when they happen. The listed activities closely follows our [company cadence](https://handbook.gitlab.com/handbook/company/cadence/). Use [this spreadsheet](https://docs.google.com/spreadsheets/d/16mPUmFe7g8VWC-b137mWiCcy6s3e_JbD6i4nE1igSOM/edit#gid=0) to edit this markdown table.
Activity | Cadence | Type | Teams Involved  
---|---|---|---  
[GitLab.com Deployments](https://handbook.gitlab.com/handbook/engineering/releases/#gitlabcom-deployments) | Continuously | Async | Delivery Engineering  
...
[Issue Updates](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#weekly-async-issue-updates) | Weekly | Async | Fulfillment Section  
...
[Monthly Self-Managed Releases](https://handbook.gitlab.com/handbook/engineering/releases/#self-managed-releases) | Monthly | Async | Delivery Engineering  
[Monthly Release Posts](https://handbook.gitlab.com/handbook/marketing/blog/release-posts/) | Monthly | Async | Product and Marketing Functions  
[Milestone Planning](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#planning) | Monthly | Async | Fulfillment Utilization,, Provision, and InfraDev Groups  
...
[Board Meetings](https://handbook.gitlab.com/handbook/board-meetings/#board-meeting-schedule) | Quarterly | Async | Fulfillment PMs, E-Group, Board  
## Working Groups and Cross-Functional Initiatives[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#working-groups-and-cross-functional-initiatives)
This table lists recurring activities that are part of [working groups and cross-functional initiatives](https://handbook.gitlab.com/handbook/company/working-groups/). Use [this spreadsheet](https://docs.google.com/spreadsheets/d/16mPUmFe7g8VWC-b137mWiCcy6s3e_JbD6i4nE1igSOM/edit#gid=463091797) to edit this markdown table.
Activity | Cadence | Type | Teams Involved  
---|---|---|---  
...
## Diversity, Inclusion, and Belonging[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#diversity-inclusion-and-belonging)
See the [Fulfillment Section DIB page](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/dib/) for more information about our DIB initiatives, including Fulfillment social events.
## Performance indicators[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#performance-indicators)
See the [Fulfillment Section Performance Indicators](https://internal.gitlab.com/handbook/company/performance-indicators/product/fulfillment-section/#regular-performance-indicators) as well as the [Centralized Engineering Dashboards](https://handbook.gitlab.com/handbook/product/groups/product-analysis/engineering/dashboards/).
## Knowledge sharing[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#knowledge-sharing)
...
## Managers and direct reports[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#managers-and-direct-reports)
This table lists recurring activities between managers and their reports. Most of these activities are also listed on our [Leadership](https://handbook.gitlab.com/handbook/leadership/) and [People Group](https://handbook.gitlab.com/handbook/people-group/) pages. Use [this spreadsheet](https://docs.google.com/spreadsheets/d/16mPUmFe7g8VWC-b137mWiCcy6s3e_JbD6i4nE1igSOM/edit#gid=797662565) to edit this markdown table.
Activity | Cadence | Type | People Involved  
---|---|---|---  
[1-1 Meetings](https://handbook.gitlab.com/handbook/leadership/1-1/) | Weekly | Sync | Manager, Report  
[Career Development Conversations](https://handbook.gitlab.com/handbook/people-group/learning-and-development/career-development/) | Quarterly | Sync | Manager, Report  
[Skip-Levels Meetings](https://handbook.gitlab.com/handbook/leadership/skip-levels/) | Quarterly | Sync | Manager’s Manager, Report  
[Promotion Planning](https://handbook.gitlab.com/handbook/engineering/careers/#promotion) | Annually | Sync | Manager, Report, Function Leadership, PeopleOps  
[Talent Assessment](https://handbook.gitlab.com/handbook/people-group/talent-assessment/) | Annually | Sync | Manager, Report, Function Leadership, PeopleOps  
[Annual Compensation Reviews](https://handbook.gitlab.com/handbook/total-rewards/compensation/compensation-review-cycle/) | Annually | Sync | Manager, Report, Function Leadership, PeopleOps  
## Google groups[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#google-groups)
...
## Communicating on Slack[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#communicating-on-slack)
### List of channels[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#list-of-channels)
...
### Guidelines to ask questions in s_fulfillment slack channel[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#guidelines-to-ask-questions-in-s_fulfillment-slack-channel)
  ...
  3. For urgent support issues, please follow the [STAR escalation](https://handbook.gitlab.com/handbook/support/internal-support/support-ticket-attention-requests/) strategy.
  4. For [internal support requests](https://handbook.gitlab.com/handbook/support/internal-support/#internal-requests) regarding licensing, subscriptions, trials, or any requests involving a customer, please fill out the [internal request form](https://support-super-form-gitlab-com-support-support-op-651f22e90ce6d7.gitlab.io/).
  5. For general licensing and subscription questions, check out the [#support_licensing-subscription](https://app.slack.com/client/T02592416/C018C623KBJ) Slack channel.


## Common links[](https://handbook.gitlab.com/handbook/engineering/development/fulfillment/#common-links)
  * [Product Vision](https://about.gitlab.com/direction/fulfillment/)
  * [Fulfillment section](https://handbook.gitlab.com/handbook/product/categories/#fulfillment-section)
...
The Seat Management Team of the Fulfillment Sub-department at GitLab
...
The Subscription Management Team in the Fulfillment Sub-department at GitLab
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/development/fulfillment/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/development/fulfillment/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)