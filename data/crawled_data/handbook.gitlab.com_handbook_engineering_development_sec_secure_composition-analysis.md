...
## Composition Analysis[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#composition-analysis)
The Composition Analysis group at GitLab is charged with developing solutions which perform [Container Scanning](https://about.gitlab.com/direction/application_security_testing/composition-analysis/container-scanning/), and [Software Composition Analysis](https://about.gitlab.com/direction/application_security_testing/composition-analysis/software-composition-analysis/). See [the exhaustive list of projects](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#projects) the group maintains.
## Common Links[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#common-links)
...
## How we work[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#how-we-work)
### Workflow[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#workflow)
The Composition Analysis group largely follows GitLab’s [Engineering Workflow](https://handbook.gitlab.com/handbook/engineering/workflow/) and [Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/).
This includes:
  * [Issue triage](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/)
  * [Infradev triage](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#triaging-vulnerabilities)
  * [Wider Community Merge Request Triage](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/merge-request-triage/)
  * [Retrospectives](https://handbook.gitlab.com/handbook/engineering/careers/management/group-retrospectives/)


#### Indicating Status and Raising Risk[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#indicating-status-and-raising-risk)
...
Follow these steps when raising or downgrading risk:
  ...
  3. Copy the Engineering Manager and Product Manager in a comment.


### Time-off Calendar[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#time-off-calendar)
...
To share your time-off:
  ...
  2. Under `Home`, click on `Your Events` to show a dropdown.
  3. Click on ‘Calendar Sync’ under the Settings break.
  4. Click `Add calendar` under `Additional calendars to include?`. Use the calendar ID above.


To visualize the calendar:
  1. In Google Calendar, find the `Other calendars` section in the left sidebar.
  2. Click on the ➕ icon and then select `Subscribe to calendar`. Use the calendar ID above.


### Reaction rotation[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#reaction-rotation)
...
Neither engineer should be allocated to work on Features or critical deliverables. In the context of [Cross-functional milestone planning](https://handbook.gitlab.com/handbook/product/product-processes/cross-functional-prioritization/#cross-functional-milestone-planning), their allocation counts towards the bugs and maintenance ratio.
The [rotation schedule](https://gitlab.com/groups/gitlab-org/secure/-/epics/2#schedule) follows the development cycle, which means using the start/end dates from the GitLab [product milestones](https://handbook.gitlab.com/handbook/product/product-processes/#understanding-milestones-and-releases). When creating the schedule, the Engineering Manager should aim to minimize the number of back-to-back rotations that engineers do.
Please keep track of the actions you’re doing during your rotation and add notes in the corresponding issue (e.g., copying tools command executed locally, sharing relevant changes to projects and processes, etc.), You can use the [Reaction Rotation issue template](https://gitlab.com/gitlab-org/secure/general/-/blob/master/.gitlab/issue_templates/Reaction%20Rotation%20SCA.md?ref_type=heads) for this purpose.
...
#### Responsibilities - Security[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#responsibilities---security)
  1. Triage vulnerabilities reported on the projects we maintain and help resolve them depending on their priority. (See [Security vulnerabilities triaging process](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#security-vulnerabilities-triaging-process))
  2. Check for `SLA::Breached` issues.
  3. Check for security [automation failures](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/#automation-failures)
  4. Check for new security releases of our dependencies and ensure we use them: 
    1. Upstream scanners (see [Updating an upstream scanner](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#updating-an-upstream-scanner))
    2. Container base images
    3. Application dependencies
    4. Programming language
  5. Refine scheduled security issues.
  6. Consider creating or updating any automation or tooling (related to security, maintainership or support!)


#### Responsibilities - Support[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#responsibilities---support)
  1. Monitor Slack channels for questions, support requests, and alerts. While other team members may respond to these requests, the engineer assigned to the reaction rotation is expected to handle them primarily. If a support engineer requests assistance via Slack and it requires investigation or debugging, they should be directed to raise an issue in [the Request for Help project](https://gitlab.com/gitlab-com/request-for-help#sec-section). 
  ...
  2. Monitor [Section Sec Request For Help](https://gitlab.com/gitlab-com/sec-sub-department/section-sec-request-for-help/-/issues/?label_name=Help%20group%3A%3Acomposition%20analysis) project for support requests.
  3. Refine scheduled bugs and maintenance issues.


These items must be triaged continuously throughout the milestone which means they must be checked multiple times a week.
#### Responsibilities - Maintainership[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#responsibilities---maintainership)
  1. Work with community contributors to help drive [their merge requests](https://gitlab.com/groups/gitlab-org/-/merge_requests?scope=all&state=opened&label_name\[\]=group%3A%3Acomposition%20analysis&label_name\[\]=Community%20contribution) to completion (more information on [community contributions triaging process](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/merge-request-triage/)).
  2. Run the [License Alias Generator](https://gitlab.com/gitlab-org/security-products/license-db/license-alias-generator/-/tree/main?ref_type=heads) tool to update the list of [known alias](https://gitlab.com/gitlab-org/security-products/license-db/license-processor/-/blob/main/data/aliases.go?ref_type=heads). You can find instructions [here](https://gitlab.com/gitlab-org/security-products/license-db/license-alias-generator/-/tree/main?ref_type=heads#workflow). This action should be performed once during a milestone.
  3. Check for new versions of languages or package managers that we support, or deprecation / removal of support for the same and notify Engineering Manager and Product Manager via issue.
  4. Check for new versions of our dependencies (not related to security): 
    1. Upstream scanners (see [Updating an upstream scanner](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#updating-an-upstream-scanner)).
    2. Container base images.
    3. Application dependencies.
    4. Programming language.
  5. Check in on test failures. Check relevant slack channels ([#g_ast-composition-analysis-alerts](https://gitlab.slack.com/archives/C04UX9MQNSJ), [#s_ast-alerts](https://gitlab.slack.com/archives/CAU9SFKNU)).
  6. Check latest pipelines for any release failures. If any issue is preventing the automated release process from running, begin the [release failure escalation process](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#release-failure-process).
  7. Consider creating or updating any automation or tooling (related to security, maintainership or support!).
  8. Monitor failures and errors on license-db project, use the `#f_licese_database` Slack channel for communication about these items, so other team members can provide the support.
  9. Monitor the Slack channel `#g_ast-composition-analysis-alerts` for any incidents on the license-db infrastructure. - In case of an incident react with 👁️ to indicate that you are looking into it. - If the incident isn’t resolved in 30 minutes or more, investigate on it. - Write down in the incident Slack thread all the steps that were done to resolve it.
  10. Monitor the Slack channels `#f_operational_container_scanning` and `#f_container_scanning` for alerts related to Operational Container Scanning (OCS) and Container Scanning.


#### Handover[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#handover)
...
### Reaction Rotation Handover Template[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#reaction-rotation-handover-template)
```
...
### Security vulnerabilities triaging process[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#security-vulnerabilities-triaging-process)
...
#### SLA::Near Breach issues[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#slanear-breach-issues)
...
#### SLA::Breached issues[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#slabreached-issues)
...
#### Gemnasium vulnerabilities[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#gemnasium-vulnerabilities)
Since the new Dependency Scanner analyzer is FedRAMP supported, Gemnasium is no longer FedRAMP supported. Therefore, treat all Gemnasium vulnerabilities as `non-FedRAMP findings` when following SLA exception processes. Refer to the [SLA exceptions handbook page](https://handbook.gitlab.com/handbook/security/product-security/vulnerability-management/sla-exceptions/) for process details.
#### Triaging vulnerabilities[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#triaging-vulnerabilities)
We use the Vulnerability Report with filters to focus on items matching [our policy](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#security-policy) and reported on the relevant projects.
  1. [Analyzers Vulnerability Report](https://gitlab.com/groups/gitlab-org/security-products/analyzers/-/security/vulnerabilities/?state=DETECTED&severity=CRITICAL,HIGH&projectId=13150952,15369510,24673064,52241202,6126012,9450192&activity=STILL_DETECTED)
     * To configure the report manually, select all [shared](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#shared), [container scanning](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#container-scanning), and [dependency scanning](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#dependency-scanning) projects and apply the `Still detected` activity filter and apply the `Needs Triage` status.
  2. [License-db Vulnerability Report](https://gitlab.com/groups/gitlab-org/security-products/license-db/-/security/vulnerabilities/?state=DETECTED&severity=CRITICAL,HIGH&projectId=39193358,39229232,39233486,39298809,39622674,40857363,45266022&activity=STILL_DETECTED)
     * To configure the report manually, select all [license-db](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#license-db) projects and apply the `Still detected` activity filter and apply the `Needs Triage` status.


For each item, investigate and either [dismiss](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#dismissing-a-vulnerability) or [confirm](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#confirming-a-vulnerability) it. If it’s not clear whether there’s indeed a threat, [escalate](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#creating-security-issues) to our [Application Security team](https://handbook.gitlab.com/handbook/security/product-security/security-platforms-architecture/application-security/).
...
#### Upstream scanners vulnerabilities[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#upstream-scanners-vulnerabilities)
**This only applies to projects NOT maintained by GitLab.**
We review vulnerabilities detected on upstream scanners when upgrading to a newer version. See the [Security checks when updating an upstream scanner section](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#security-checks-when-updating-an-upstream-scanner).
...
##### Triaging vulnerabilities[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#triaging-vulnerabilities-1)
We use the Vulnerability Report with filters to focus on items matching [our policy](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#security-policy) and reported on the relevant projects.
  1. [Upstream Scanners Vulnerability Report](https://gitlab.com/groups/gitlab-org/security-products/dependencies/-/security/vulnerabilities/?state=DETECTED&projectId=30616761,30684590,35335143,39545454,39545481,51420921&severity=CRITICAL,HIGH&activity=STILL_DETECTED)
     * To configure the report manually, select all [upstream scanner](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#upstream-scanner-mirrors) projects.
...
#### Dismissing a vulnerability[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#dismissing-a-vulnerability)
...
##### Low risk findings that can be dismissed[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#low-risk-findings-that-can-be-dismissed)
...
#### Confirming a vulnerability[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#confirming-a-vulnerability)
If the vulnerability impacts a dependency:
  1. Evaluate if the dependency (software library, system library, base image, etc.) can be upgraded _or_ removed.
  2. Set the vulnerability status to “Confirmed”.
  3. Release a new version of the analyzer with the dependency upgrade/removal and follow the process on [resolving a vulnerability](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#resolving-a-vulnerability).


For all other confirmed vulnerabilities, [create a security issue](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#creating-security-issues) to discuss and track the remediation.
#### Resolving a vulnerability[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#resolving-a-vulnerability)
...
#### Creating security issues[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#creating-security-issues)
...
As a workaround, you can copy and paste the content of the vulnerability page (this keeps markdown formatting!). Please also follow our Security guidelines about [creating new security issues](https://handbook.gitlab.com/handbook/security/engaging-with-security/#creating-new-security-issues).
...
Developers reporting the security issue should help the [Application Security team](https://handbook.gitlab.com/handbook/security/product-security/security-platforms-architecture/application-security/) assess the impact of the vulnerability, and update the issue description with an `Impact` section.
If immediate feedback is required, then add a comment to the vulnerability issue with an `@`-mention directed at one of the Security Engineers listed in the [Stable Counterpart](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/#stable-counterparts) section, or ping them on slack.
### Release failure process[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#release-failure-process)
If the image release process is failing, an incident should be created to track how it was detected, escalated, and resolved. Documenting our incidents makes it possible to search for previous incidents by keyword, labels, and other issue filters. We open all of our incidents in the [main GitLab project](https://gitlab.com/gitlab-org/gitlab/-/issues/?sort=created_date&state=opened&type%5B%5D=incident&label_name%5B%5D=group%3A%3Acomposition%20analysis&first_page_size=20).
  1. [Open a new incident](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=incident&issue%5Bissue_type%5D=incident) and add a description of the problem along with any reproduction steps. Add the following labels so that we can track the incidents that have impacted composition analysis in the future.
```
...
```
  ...
  3. Link any related issues or Zoom meetings with the [quick actions](https://docs.gitlab.com/ee/operations/incident_management/linked_resources.html#using-a-quick-action) to record incident timeline events. Ensure that an event exists for the incident start, detection, resolution, and any other events that you feel are worth highlighting as part of the incident response.
...
#### Example Incident(s)[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#example-incidents)
  * [PHP Composer segfaults in gemnasium analyzer](https://gitlab.com/gitlab-org/gitlab/-/issues/383299)


### Maintenance triaging process[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#maintenance-triaging-process)
To help our Engineering Manager prioritize maintenance issues, the engineering team assigns them a [priority label](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#priority).
  ...
  2. For each open issue that has no Priority label (“Open” column), shortly investigate the issue (< 1h) and comment with your findings. Make sure the correct sub-category label is applied per our [Work type clasification](https://handbook.gitlab.com/handbook/product/groups/product-analysis/engineering/metrics/#work-type-classification) (e.g. `~maintenance::refactor`).


### Code review[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#code-review)
Upon joining Composition Analysis group, team members are suppose to become either reviewers or maintainers for all [projects](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#projects) maintained by the group. The process how to become maintainer is described in the general [Code review guidelines](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#how-to-become-a-project-maintainer).
## Projects[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#projects)
The Composition Analysis group maintains several projects to provide our scanning capabilities.
### Shared[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#shared)
  * [common library](https://gitlab.com/gitlab-org/security-products/analyzers/common)


### Dependency Scanning[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#dependency-scanning)
...
Additional notes:
  * [gemnasium-db](https://gitlab.com/gitlab-org/security-products/gemnasium-db) is maintained by [the Vulnerability Research group](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/vulnerability-research/).


### Container Scanning[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#container-scanning)
...
### License-db[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#license-db)
...
### Operational Container Scanning[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#operational-container-scanning)
...
### Dependency Management[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#dependency-management)
...
### Semver dialects gem[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#semver-dialects-gem)
  * [semver_dialects](https://gitlab.com/gitlab-org/ruby/gems/semver_dialects)


### CI/CD components[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#cicd-components)
...
### Upstream scanner mirrors[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#upstream-scanner-mirrors)
...
To do so, we mirror their repository and execute our security scans on them (when relevant):
  ...
  * [trivy-java-db](https://gitlab.com/gitlab-org/security-products/dependencies/trivy-java-db)
    * The [`oras-mirror-config`](https://gitlab.com/gitlab-org/security-products/dependencies/trivy-java-db/-/tree/oras-mirror-config?ref_type=heads) branch contains a scheduled pipeline that keeps the `registry.gitlab.com/gitlab-org/security-products/dependencies/trivy-java-db:1` image up to date.
...
The vulnerabilities reported on the currently used version of the scanner are automatically reported in [the group level Vulnerability Report](https://gitlab.com/groups/gitlab-org/security-products/dependencies/-/security/vulnerabilities/?state=DETECTED&projectId=30616761,30684590,35335143,39545454,39545481,51420921&severity=CRITICAL,HIGH&activity=STILL_DETECTED) and triaged as part of our [security vulnerabilities triaging process](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#security-vulnerabilities-triaging-process).
#### Setting up a mirror[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#setting-up-a-mirror)
...
#### Updating an upstream scanner[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#updating-an-upstream-scanner)
...
##### Upstream Tools and Analyzers list[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#upstream-tools-and-analyzers-list)
  1. [Trivy](https://gitlab.com/gitlab-org/security-products/dependencies/trivy). 
    ...
    2. [Trivy K8S wrapper](https://gitlab.com/gitlab-org/security-products/analyzers/trivy-k8s-wrapper/-/blob/main/docs/update_scanner.md)
  2. [OpenTofu](https://opentofu.org/)
    1. [Deployment](https://gitlab.com/gitlab-org/security-products/license-db/deployment)
  3. [OpenTofu component](https://gitlab.com/components/opentofu)
    1. [Deployment](https://gitlab.com/gitlab-org/security-products/license-db/deployment/-/blob/main/.gitlab-ci.yml#L5) Every analyzer relying on an upstream scanner has a “ _How to update the upstream Scanner_ ” section in their readme detailing the process. This includes a verification for possible new security vulnerabilities and a license check which are detailed below.


##### Security checks when updating an upstream scanner[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#security-checks-when-updating-an-upstream-scanner)
Before releasing an analyzer with a newer version of its upstream scanner, we must ensure it is exempt of security vulnerabilities matching our current policy.
  ...
  3. if there are new findings matching [our policy](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#security-policy), address them according to our [triage process](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#triaging-vulnerabilities).
  4. only when the above-mentioned findings are **fixed** , update the default_branch to be `NEW_VERSION-security-checks` and proceed with the update of the analyzer to use this newer version.


##### License check when updating an upstream scanner[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#license-check-when-updating-an-upstream-scanner)
Before releasing an analyzer with a newer version of its upstream scanner, we must ensure its license has not changed or is still compatible with [our policy](https://handbook.gitlab.com/handbook/engineering/open-source/#acceptable-licenses).
## FIPS runners[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#fips-runners)
To test FIPS images, we host our own runner instances. You can find these by filtering the [VM instances](https://console.cloud.google.com/compute/overview?invt=Ab6F3g&project=group-secure-a89fe7). for `sca-fips-runner-`. If you need to provision a new runner, use the [provisioning script](https://gitlab.com/gitlab-org/security-products/analyzers/gemnasium/-/blob/6f1125442490f931a61d30f2e24bb31e473a3927/scripts/create_fips_runner.sh) and follow the included directions.
## Monitoring[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#monitoring)
...
## Related resources[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#related-resources)
...
## Runbooks[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#runbooks)
See our [Composition Analysis Runbooks](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/runbooks/) page.
## Slack alerts[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/composition-analysis/#slack-alerts)
The following table presents the various GitLab projects that can generate slack alerts. Please notice that this doesn’t include alerts generated by Sentry. If you change the name of any of the Slack channels, please update the integrations in the projects, so that the alerts continue to function.
...
Overview This page lists runbooks used by the Composition Analysis team. Runbooks Package Metadata …
Last modified March 11, 2026: [add vulnerability page (`91818e71`)](https://gitlab.com/gitlab-com/content-sites/handbook/commit/91818e71)
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/development/sec/secure/composition-analysis/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/development/sec/secure/composition-analysis/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)