...
## Secret Detection[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#secret-detection)
...
### Common Links[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#common-links)
...
#### Secret Detection Shared Calendar[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#secret-detection-shared-calendar)
...
### Our Team[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#our-team)
Name | Role  
---|---  
## How We Work[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#how-we-work)
...
### Issue Boards[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#issue-boards)
...
#### Issue and Merge Requests labels[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#issue-and-merge-requests-labels)
...
#### Refinement[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#refinement)
We have recently experimented with a [new refinement process](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/planning/#refinement) when refining the issues for the [Secret Push Protection Beta epic](https://gitlab.com/groups/gitlab-org/-/epics/12729). This process draws a lot of inspiration from other sections/stages but also aligns with the current [Secure Engineering Refinement](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/planning/).
...
##### Steps[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#steps)
Below is a list of steps followed during the refinement process.
  ...
  * Engineers would follow a certain [checklist](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#checklist) to determine if an issue is refined and ready to be picked up.
...
##### Checklist[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#checklist)
...
### Unplanned work[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#unplanned-work)
...
#### Support to customers and prospects[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#support-to-customers-and-prospects)
...
### Observability[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#observability)
...
#### Metrics[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#metrics)
The process to add metrics to our projects is documented in our [Metrics](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/metrics/) page.
#### Runbooks[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#runbooks)
The process for monitoring, responding to, and mitigating incidents is documented within our [Secret Detection Runbooks](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/runbooks/) page.
### Rule Development[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#rule-development)
Secret Detection(SD) analyzers use [GitLab-managed ruleset](https://gitlab.com/gitlab-org/security-products/secret-detection/secret-detection-rules) when running Secret Detection scans. To increase the rule coverage of our analyzers, we collaborate with [Vulnerability Research](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/vulnerability-research/) team members to develop rules supporting secret credential types of various vendors (companies). Though our analyzers already [support](https://docs.gitlab.com/user/application_security/secret_detection/detected_secrets/) 200+ popular credential types, we aim to cover more to expand rule coverage.
#### Expanding Rule Coverage[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#expanding-rule-coverage)
...
#### Release Process[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#release-process)
...
### Secret Detection CVE Investigation and Resolution Process[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#secret-detection-cve-investigation-and-resolution-process)
#### Weekly CVE Review[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#weekly-cve-review)
On a weekly basis, review reported CVEs to investigate severity, applicability, and resolution status.
#### Access the CVE Dashboard[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#access-the-cve-dashboard)
...
#### Investigation Process[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#investigation-process)
...
#### Resolution Actions[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#resolution-actions)
...
#### Closure[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#closure)
...
#### Additional Notes[](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/#additional-notes)
...
* * *
#####  [Rule Development Process](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/rule-development-process/)
Overview The Secret Detection rule development process primarily involves creating an appropriate …
#####  [Secret Detection Metrics](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/secret-detection/metrics/)
Overview This page documents the process a member of the Secure: Secret Detection team should use to …
...
Overview This page lists runbooks used by the Secret Detection team for monitoring, mitigating and …
Last modified February 11, 2026: [Added Secret Detection CVE Investigation and Resolution Process (`48b02fe6`)](https://gitlab.com/gitlab-com/content-sites/handbook/commit/48b02fe6)
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/development/sec/secure/secret-detection/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/development/sec/secure/secret-detection/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)