...
## Customer outcomes we are driving for at GitLab[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#customer-outcomes-we-are-driving-for-at-gitlab)
...
## Top Priorities for FY25[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#top-priorities-for-fy25)
...
## Security Insights Team Structure[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#security-insights-team-structure)
...
### Team Structure[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#team-structure)
Name | Role  
---|---  
## Common Links[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#common-links)
  * Slack channels: 
    * Main channel: [`#g_srm_security_insights`](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#ZgotmplZ)
    * Engineering - All SRM groups: [`#s_srm_eng`](https://gitlab.enterprise.slack.com/archives/C05N5BLDYUT)


### Prioritization[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#prioritization)
...
### Product Workflow[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#product-workflow)
The Security Insights group largely follows GitLab’s [Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/).
Additional information can be found on the [Planning page](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/srm-planning/).
### Milestone Planning[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#milestone-planning)
...
### Project Estimation[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#project-estimation)
...
#### High Level Estimation[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#high-level-estimation)
...
### Tracking Deliverables[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#tracking-deliverables)
...
#### Weekly async issue updates[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#weekly-async-issue-updates)
...
#### Indicating Status and Raising Risk[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#indicating-status-and-raising-risk)
...
Follow these steps when raising or downgrading risk:
  ...
  2. Add a comment about why the risk has increased or decreased. Copy the Engineering Manager and Project Manager for awareness.
...
### Support rotation[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#support-rotation)
...
If you are **not** the nominated person in a given week then:
  ...
  2. You should redirect the question to the nominated person (e.g. if it comes in a DM in Slack, redirect it to our public channel).
...
#### Triage expectations[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#triage-expectations)
...
#### Responsibilities - Support[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#responsibilities---support)
  1. Monitor slack channels for questions, support requests, and alerts. The person assigned to the reaction rotation is expected to handle them primarily. If a support engineer requests assistance via Slack and it requires investigation or debugging, they should be directed to raise an issue in [a dedicated project](https://gitlab.com/gitlab-com/sec-sub-department/section-sec-request-for-help).
...
### MR Reviews[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#mr-reviews)
We follow these guidelines when submitting MRs for review when the change is within the Security Insights domain:
  ...
  2. For time-critical reviews, consider using internal reviewers and maintainers.
  3. The initial review should be performed by a member of the team. This helps the team by: 
  ...
  4. GraphQL merge requests should be reviewed by a frontend engineer as soon as possible. This helps to validate the interface, and allows changes to be made before tests are written.


### Issue Boards[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#issue-boards)
...
## Quality[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#quality)
## Quality and E2E Specs[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#quality-and-e2e-specs)
### Workflow of E2E runs on Staging and Production[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#workflow-of-e2e-runs-on-staging-and-production)
...
For full details of scheduled E2E test pipelines running against live environments see [E2E test pipelines](https://handbook.gitlab.com/handbook/engineering/testing/end-to-end-pipeline-monitoring/#end-to-end-e2e-test-pipelines).
### Running and Fixing E2E specs[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#running-and-fixing-e2e-specs)
#### Prerequisites[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#prerequisites)
...
#### Running QA Tests[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#running-qa-tests)
Use the following command to run tests locally against your GDK instance:
#### Running against your `gdk`[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#running-against-your-gdk)
...
You can also run a specific RSpec line using :<line_number> to target the surrounding example block. See [RSpec best practices](https://docs.gitlab.com/development/testing_guide/best_practices/#rspec) for more details.
...
#### Running against staging[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#running-against-staging)
```
...
#### Local testing of licensed features[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#local-testing-of-licensed-features)
...
```
  ...
  2. Within the same shell session, run:
```
...
```
  ...
  3. Navigate to **Admin > Settings > General > “Account and limit”**, and enable “Allow use of licensed EE features”.


See the [related handbook entry](https://docs.gitlab.com/ee/development/ee_features.html#act-as-saas) for more details.
### Troubleshooting common errors and fixes[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#troubleshooting-common-errors-and-fixes)
...
### Running E2E specs in the MR pipeline[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#running-e2e-specs-in-the-mr-pipeline)
...
### Running Govern E2E specs locally against GDK[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#running-govern-e2e-specs-locally-against-gdk)
...
### E2E tests with feature flags[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#e2e-tests-with-feature-flags)
E2E tests should pass with a feature flag enabled before it is enabled on Staging or on GitLab.com. Therefore, it’s important to confirm this when introducing a new feature flag. Adding or editing a feature flag definition file [starts two `e2e:test-on-omnibus` jobs](https://docs.gitlab.com/ee/development/testing_guide/end_to_end/feature_flags.html#automatic-test-execution-when-a-feature-flag-definition-changes) (one with the feature flag turned on and another where it’s turned off).
...
## Notes and Resources on QA Testing[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#notes-and-resources-on-qa-testing)
For any questions, reach out to [#s_developer_experience](https://gitlab.enterprise.slack.com/archives/C07TWBRER7H).
### Resources[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#resources)
  * [Testing at GitLab handbook page](https://handbook.gitlab.com/handbook/engineering/testing/)
  ...
  * [E2E testing overview video](https://handbook.gitlab.com/handbook/engineering/testing/#-gitlab-end-to-end-testing-overview-video)


## Monitoring[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#monitoring)
...
## Contributing[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#contributing)
### Local testing of licensed features[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#local-testing-of-licensed-features-1)
When a feature needs to check the current license tier, it’s important to make sure this also works on GitLab.com.
To emulate this locally, follow these steps:
...
See the [related handbook entry](https://docs.gitlab.com/ee/development/ee_features.html#act-as-saas) for more details.
### Cross-stack collaboration[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#cross-stack-collaboration)
...
### Community Contributions[](https://handbook.gitlab.com/handbook/engineering/development/sec/security-risk-management/security-insights/#community-contributions)
...
Setup Guide for Vulnerability Explanation and Resolution Several setup steps are necessary in order …
...
Troubleshooting Resource Guide for VE and VR When working with Vulnerability Resolution and …
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/development/sec/security-risk-management/security-insights/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/development/sec/security-risk-management/security-insights/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)