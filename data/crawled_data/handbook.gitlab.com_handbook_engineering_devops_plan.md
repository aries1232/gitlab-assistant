# Plan
Plan teams:
  * [Plan:Project Management Team](https://handbook.gitlab.com/handbook/engineering/devops/plan/project-management/)
  * [Plan:Product Planning Team](https://handbook.gitlab.com/handbook/engineering/devops/plan/product-planning/)
  * [Plan:Knowledge Team](https://handbook.gitlab.com/handbook/engineering/devops/plan/knowledge/)


The responsibilities of this collective team are described by the [Plan stage](https://handbook.gitlab.com/handbook/product/categories/#plan-stage). Among other things, this means working on GitLab’s functionality around issues, boards, milestones, to-do list, issue lists and filtering, roadmaps, time tracking, requirements management, notifications, value stream analytics (VSA), wiki, and pages.
  * I have a question. Who do I ask?


In GitLab issues, questions should start by @ mentioning the Product Manager for the [corresponding Plan stage group](https://handbook.gitlab.com/handbook/product/categories/#plan-stage). GitLab team-members can also use [#s_plan](https://gitlab.slack.com/messages/C72HPNV97).
For UX questions, @ mention the Product Designers on the Plan stage; [Nick Leonard](https://gitlab.com/nickleonard) for Plan:Project Management, [Nick Brandt](https://gitlab.com/nickbrandt) for Plan:Product Planning, and [Libor Vanc](https://gitlab.com/lvanc) for Plan:Optimize. Plan:Knowledge should follow the [process for groups without a designer](https://handbook.gitlab.com/handbook/product/product-processes/).
### How we work[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#how-we-work)
...
### Workflow[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#workflow)
We work in a continuous Kanban manner while still aligning with Milestones and [GitLab’s Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/).
#### Capacity Planning[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#capacity-planning)
...
The third item tells us how we’ve been doing previously. If the trend is downwards, we can look to discuss this in our [retrospectives](https://handbook.gitlab.com/handbook/engineering/devops/plan/#retrospectives).
...
#### Estimating effort[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#estimating-effort)
...
##### Key Principles[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#key-principles)
...
##### Weight Definitions[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#weight-definitions)
Weight | Meaning  
---|---  
...
#### Issues[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#issues)
...
![plan-workflow-example.png](https://handbook.gitlab.com/images/engineering/devops/dev/plan/plan-workflow-example.png)
Everyone is encouraged to move issues to different workflows if they feel they belong somewhere else. In order to keep issues constantly refined, when moving an issue to a different workflow stage, please review any open discussions within the issue and update the description with any decisions that have been made. This ensures that descriptions are [laid out clearly](https://handbook.gitlab.com/handbook/values/#say-why-not-just-what), keeping with our value of Transparency.
#### Epics[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#epics)
...
#### Design Documents[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#design-documents)
For all tier T1 and T2 roadmap items, and initiatives spanning multiple milestones, we recommend creating [a design document](https://handbook.gitlab.com/handbook/engineering/architecture/design-documents/) using the [Architecture design workflow](https://handbook.gitlab.com/handbook/engineering/architecture/workflow/). This approach offers several benefits:
  ...
  2. **Increased Visibility** : By creating design documents, we raise awareness of the work done in the Plan stage, such as the [work items framework](https://handbook.gitlab.com/handbook/engineering/architecture/design-documents/work_items/), [configurable Work Item Types](https://handbook.gitlab.com/handbook/engineering/architecture/design-documents/configurable_work_item_types/), [custom fields](https://handbook.gitlab.com/handbook/engineering/architecture/design-documents/work_items_custom_fields/), [custom status](https://handbook.gitlab.com/handbook/engineering/architecture/design-documents/work_items_custom_status/), [GLQL](https://handbook.gitlab.com/handbook/engineering/architecture/design-documents/glql/), frontend-driven views, and many more.
  3. **Discoverability** : Design documents are easily accessible [through our public handbook](https://handbook.gitlab.com/handbook/engineering/architecture/design-documents/), aligning with engineering best practices.
  4. **Collaborative Decision-Making** : [Changes and discussions occur through merge requests](https://handbook.gitlab.com/handbook/engineering/architecture/workflow/#why-are-design-documents-tracked-in-merge-requests), ensuring visibility to all involved team members.
...
This is the recommended workflow for all initiatives:
  ...
  2. Develop a design document using the Architecture evolution workflow. Get started using [this template](https://gitlab.com/gitlab-com/content-sites/handbook/-/blob/main/content/handbook/engineering/architecture/design-documents/_template.md?plain=1). You don’t need to fill out all sections. This is a living document and it’s expected that it evolves over time.
...
### Roadmap[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#roadmap)
...
Most items being reviewed during roadmap planning have not yet had detailed technical investigation from engineering. Planning at this resolution is intended to be thoughtful but not perfect. Velocity [remains our priority](https://handbook.gitlab.com/handbook/engineering/development/principles/#velocity).
#### Reviewing the Roadmap[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#reviewing-the-roadmap)
...
#### Roadmap Organization[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#roadmap-organization)
```
graph TD;
...
The DRI maintains a Wiki page or design document for the project containing a project timeline, project status, links to work items, key participants, a [dogfooding proposal](https://handbook.gitlab.com/handbook/engineering/devops/plan/#dogfooding), and a decision register. This is encouraged for all important projects, especially Tier 1 and Tier 2 Roadmap commitments. It acts as a Single Source of Truth (SSoT) that greatly improves cross-functional collaboration and ensures decisions made are captured. Previous examples are:
...
#### Internal Testing[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#internal-testing)
...
##### Alpha Testing[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#alpha-testing)
...
##### End-of-line testing[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#end-of-line-testing)
...
#### Dogfooding[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#dogfooding)
...
### Talking With Customers[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#talking-with-customers)
We aim to have cross-functional representation in every conversation we have with customers.
#### Customer Conversations calendar[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#customer-conversations-calendar)
...
#### Shadow a customer call[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#shadow-a-customer-call)
...
To ensure upcoming calls appear in your calendar, subscribe to the Plan Customer Conversations calendar. Product Managers add upcoming customer interviews to this calendar and you’re welcome to shadow any call.
  ...
  3. In the “Add Calendar” input, paste gitlab.com_5icpbg534ot25ujlo58hr05jd0@group.calendar.google.com


Upcoming customer calls will often be advertised in the #s_plan channel in advance, so look out there also.
#### Review previous calls[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#review-previous-calls)
...
#### Review previous UX Research calls[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#review-previous-ux-research-calls)
...
### Board Refinement[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#board-refinement)
We perform many board refinement tasks asynchronously, using GitLab issues in the [Plan project](https://gitlab.com/gitlab-org/plan). The policies for these issues are defined in [triage-ops/policies/plan-stage](https://gitlab.com/gitlab-org/quality/triage-ops/tree/master/policies/plan-stage). A full list of refinement issues is available by [filtering by the ~“Plan stage refinement” label](https://gitlab.com/gitlab-org/plan/issues?label_name%5B%5D=Plan+stage+refinement).
### Tracking Committed Work for an Upcoming Release[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#tracking-committed-work-for-an-upcoming-release)
...
### Keeping Health Status Accurate[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#keeping-health-status-accurate)
...
#### Health Status Definitions for Plan[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#health-status-definitions-for-plan)
...
#### Flagging Risk is not a Negative[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#flagging-risk-is-not-a-negative)
...
### OKRs[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#okrs)
#### Active Quarter OKRs[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#active-quarter-okrs)
...
#### Previous Quarter OKRs[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#previous-quarter-okrs)
...
#### Drafting OKRs using GitLab[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#drafting-okrs-using-gitlab)
Guidance is available, including a video guide, on [Approach to OKRs at GitLab](https://handbook.gitlab.com/handbook/company/okrs/). GitLab currently offers some freedom in how to structure OKR hierarchies. We take the following approach in Plan:
  ...
  * Product development goals are established in milestone planning, following the regular [Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/), and not in OKRs.
...
### Retrospectives[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#retrospectives)
...
Retrospective issues are created by a scheduled pipeline in the [async-retrospectives](https://gitlab.com/gitlab-org/async-retrospectives) project. They are then updated once the milestone is complete with shipped and missed deliverables. For more information on how it works, see that project’s README.
...
#### Timeline[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#timeline)
...
#### Concluding the Retrospective[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#concluding-the-retrospective)
...
In both the summary comment and video the DRI should be particularly careful to ensure all information disclosed is [SAFE](https://handbook.gitlab.com/handbook/legal/safe-framework/). If the retrospective discussion contains examples of unSAFE information, the issue should not be made public.
### Regressions[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#regressions)
...
Engineering Managers are strongly encouraged to conduct a simple [Root Cause Analysis](https://handbook.gitlab.com/handbook/engineering/workflow/root-cause-analysis/#what-is-a-root-cause-analysis) (RCA) when a regression takes place in a feature owned by their group, in order to:
...
### Technical Debt[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#technical-debt)
...
### UX[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#ux)
The Plan UX team supports [Product Planning](https://handbook.gitlab.com/handbook/product/categories/#product-planning-group), [Project Management](https://handbook.gitlab.com/handbook/product/categories/#project-management-group) and [Optimize](https://handbook.gitlab.com/handbook/product/categories/#optimize-group). Product Planning and Project Management are focused on the work items architecture effort. This page focuses mainly on the specifics of how we support this, since it requires alignment and cross-group collaboration.
#### UX issue management, weights and capacity planning[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#ux-issue-management-weights-and-capacity-planning)
...
All issues worked on by a designer should have a UX weight before work is scheduled for a milestone.
  * Issue weights should follow the [UX Department’s definitions](https://handbook.gitlab.com/handbook/product/ux/product-designer/capacity-management/#ux-issue-weights).
...
#### Work Items[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#work-items)
...
##### About work items[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#about-work-items)
The first objects built using the work items architecture support the [Parker](https://handbook.gitlab.com/handbook/product/personas/#parker-product-manager), [Delaney](https://handbook.gitlab.com/handbook/product/personas/#delaney-development-team-lead) and [Sasha](https://handbook.gitlab.com/handbook/product/personas/#sasha-software-developer) personas in tasks related to planning and tracking work. Additional objects will be added in the future, supporting a variety of user personas.
...
##### Terminology[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#terminology)
...
##### Guiding principles[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#guiding-principles)
  ...
  * MVCs provide value to users, are bug-free and a highly usable experience, as described in [Product Principles](https://handbook.gitlab.com/handbook/product/product-principles/#the-minimal-valuable-change-mvc).


#### How the architecture is intended to work[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#how-the-architecture-is-intended-to-work)
...
##### Design Process for Work Items[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#design-process-for-work-items)
...
The quad that owns the code for the object (incident, epic, etc) decides if something should use the work item architecture based on trade-offs around code reuse and user experience. This should be a cross-functional decision, and the group Product Designer should advise their team regarding how well the user’s ideal workflow could or could not be supported by the work items architecture. This will allow the team to evaluate how much existing frontend pieces of the architecture could be re-used, and what would need to be added or customized in order to support the desired experience.
  ...
  2. During this phase, the Product Designer and Product Manager should ensure that success metrics are defined per our work item research process (link TBD)
  3. High level wireframes should be produced to ensure everyone has a shared understanding of what is wanted and to establish a medium term vision for the work.
...
##### Research Process for Work Items[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#research-process-for-work-items)
We use the methods and tools in the [UX Research handbook](https://handbook.gitlab.com/handbook/product/ux/experience-research/).
...
### Plan Weekly Digest[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#plan-weekly-digest)
#### Background[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#background)
...
#### Process[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#process)
  1. A new confidential issue is created every **Monday, 8 UTC**. (automatically)
  2. The issue is assigned to a Plan Engineering Manager according to the schedule below. Their role is to remind others to contribute.
  3. On **Saturday, 8 UTC** all team members are reminded to read the updates on the issue via a comment (automatically).
  4. On Friday, 8 UTC (next week) the issue is closed.


#### DRIs[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#dris)
...
#### Links[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#links)
...
### Meetings[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#meetings)
Most of our group meetings are recorded and publicly available on YouTube in the [Plan group playlist](https://www.youtube.com/playlist?list=PL05JrBw4t0KoceqcTneOVmAzhEp6NinY0).
#### Weekly group meeting[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#weekly-group-meeting)
...
The meeting was removed as its functions are now covered in other ways:
  * Slack
  * [Stage Working Groups](https://handbook.gitlab.com/handbook/engineering/devops/plan/#stage-working-groups)
  * Group meetings
  * Smaller ad-hoc meetings
  * Social call


#### Links / References[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#links--references)
...
#### Shared calendar[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#shared-calendar)
...
### Team Day[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#team-day)
...
#### Setting a date[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#setting-a-date)
...
#### Sessions[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#sessions)
...
#### Participation[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#participation)
...
#### Expenses[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#expenses)
...
The DRI for organizing Team Day may pursue a budget for expenses under existing budgets; such as the [team building](https://handbook.gitlab.com/handbook/finance/expenses/#team-building) budget. If successful it should be made clear to team-members well in advance:
...
#### Past Team Days[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#past-team-days)
...
#### Tips for a Successful Team Day[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#tips-for-a-successful-team-day)
  ...
  * Ensure Google Calendar events are transferred from the planning issue to the Plan [Shared Calendar](https://handbook.gitlab.com/handbook/engineering/devops/plan/#shared-calendar) a week in advance of the event date.
...
### Team Process[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#team-process)
Each group within the Plan stage follows GitLab’s [product development flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/) and [process](https://handbook.gitlab.com/handbook/product/product-processes/). This allows for consistency across the stage, enables us to align with other stages and stable-counterparts, and enables us to clearly understand our throughput and velocity. We’re currently focused on strictly following the process stated in the handbook, as opposed to creating our own local optimizations.
...
#### Active Stage Working Groups[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#active-stage-working-groups)
  1. [Work Items API Performance](https://handbook.gitlab.com/handbook/engineering/devops/plan/working-groups/work-items-api-performance/)


#### Archived Stage Working Groups[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#archived-stage-working-groups)
  1. [Epic Work Items Migration](https://handbook.gitlab.com/handbook/engineering/devops/plan/working-groups/epic-work-items-migration/)


### Product Outreach[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#product-outreach)
...
#### Product Shadowing schedule[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#product-shadowing-schedule)
Engineering team-members can shadow a product stable-counterpart. Shadowing sessions last two working days, or the equivalent split over multiple days to maximize experience with different functions of the role. In particular, the session should include at least one customer call. To shadow a counterpart on the team:
  ...
  2. Create a WIP MR to this page to update the table below, adding your name and issue link, and
  3. When your counterpart is assigned to the issue, add their name, remove WIP status and assign to your manager for review.
...
### Speed Runs[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#speed-runs)
  * Labels 
...
### Engineering Scaling Targets[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#engineering-scaling-targets)
...
---|---|---|---|---|---|---  
Redis Primary CPU | Unexpected load on the Shared State Redis instance caused by `SUBSCRIBE`, `UNSUBSCRIBE` and `PUBLISH` commands. | Unknown | November 2023 |  [150k Concurrent WebSocket Connections](https://gitlab.com/gitlab-com/www-gitlab-com/-/issues/11747#action-cable-websockets) at peak |  | Okay  
Redis Memory | Retention of Action Cable messages in Redis Shared State memory due to high numbers of and/or stalled/hung clients. | Unknown | November 2023 |  [150k Concurrent WebSocket Connections](https://gitlab.com/gitlab-com/www-gitlab-com/-/issues/11747#action-cable-websockets) at peak | [#326364](https://gitlab.com/gitlab-org/gitlab/-/issues/326364) | Okay  
Primary DB | Scaling a combined ‘Work Items’ table consisting of all current issues, epics, requirements and test cases. | Unknown | November 2024 |  [50k Work Items](https://handbook.gitlab.com/handbook/engineering/devops/plan/#work-items) created per day |  | Okay  
...
#### Current Large Tables[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#current-large-tables)
...
### Metrics[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#metrics)
#### Plan xMAU[](https://handbook.gitlab.com/handbook/engineering/devops/plan/#plan-xmau)
  * [Product Planning Performance Indicators](https://internal.gitlab.com/handbook/company/performance-indicators/product/)


* * *
#####  [Plan Frontend Engineer Internship](https://handbook.gitlab.com/handbook/engineering/devops/plan/internship/)
Overview The Plan Frontend Team internship is the result of The Engineering Internship Pilot Program …
#####  [Plan:Knowledge Engineering Team](https://handbook.gitlab.com/handbook/engineering/devops/plan/knowledge/)
Plan:Knowledge team The Plan:Knowledge team develops Knowledge Management categories: Wiki GitLab …
#####  [Plan:Product Planning Engineering Team](https://handbook.gitlab.com/handbook/engineering/devops/plan/product-planning/)
...
#####  [Working Groups](https://handbook.gitlab.com/handbook/engineering/devops/plan/working-groups/)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/devops/plan/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/devops/plan/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)