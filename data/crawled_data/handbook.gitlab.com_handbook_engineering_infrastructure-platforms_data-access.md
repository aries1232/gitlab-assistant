...
## Vision[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/#vision)
...
It is the job of each Data Access team to hold feature owners _accountable_ for responsible access patterns and to thereby ensure the stability of our shared data storage systems. This is an active process and requires building relationships for collaboration, guiding through paved paths, and providing tools and knowledge Team Members can use and build on.
## About sustainability and availability[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/#about-sustainability-and-availability)
Here, _sustainability_ means long-term maintainability, efficiency, and scalability of our data storage systems and the software architecture that uses it. Good sustainability requires good up-front planning as well as continued adaptation as features, business goals and infrastructure evolve. Effects of new additions and changes must be considered in the context of the entire GitLab application and the storage infrastructure.
_Availability_ means that critical user journeys continuously provide great user experience, during normal operations as well as state transitions such as migrations or upgrades. We must design our architecture, processes and tools such that they minimize interruptions and quality degradations.
## Achieving the vision[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/#achieving-the-vision)
### What we do[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/#what-we-do)
...
### FY26 goals[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/#fy26-goals)
(in alignment with GitLab’s [product principles](https://handbook.gitlab.com/handbook/product/product-principles/#our-product-principles) and the [[INTERNAL] Three year (FY26-FY28) - Platforms strategy](https://docs.google.com/document/d/1E5T9TSkqxWkvCpWNbfrqmEFM5sXMO4HT-D22m_QjfyA/edit?tab=t.0))
...
### Principles for launches[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/#principles-for-launches)
...
## All Team Members[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/#all-team-members)
The following people are permanent members of teams that belong to the Data Access Sub-department:
### Gitaly[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/#gitaly)
The [Gitaly](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/tenant-scale/gitaly/) team builds and maintains systems to ensure Git data of GitLab instances, and _GitLab.com in particular_ , is reliable, secure and fast.
Name | Role  
---|---  
[![John Cai](https://about.gitlab.com/images/team/johncai-crop.jpg)John Cai](https://handbook.gitlab.com/handbook/company/team/#jcaigitlab) | [Engineering Manager, Gitaly](https://handbook.gitlab.com/job-families/engineering/development/management/engineering-manager/)  
### Git[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/#git)
The [Git](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/tenant-scale/git/) team develops Git in accordance with the goals of the community and GitLab, and integrate it into our products.
Name | Role  
---|---  
[![Christian Couder](https://about.gitlab.com/images/team/christiancouder-crop.jpg)Christian Couder](https://handbook.gitlab.com/handbook/company/team/#chriscool) | [Staff Backend Engineer, Git](https://handbook.gitlab.com/job-families/engineering/development/backend/#git)  
[![Justin Tobler](https://about.gitlab.com/images/team/justintobler-crop.jpg)Justin Tobler](https://handbook.gitlab.com/handbook/company/team/#justintobler) | [Senior Backend Engineer, Git](https://handbook.gitlab.com/job-families/engineering/development/backend/#git)  
[![Karthik Nayak](https://about.gitlab.com/images/team/karthiknayak-crop.jpg)Karthik Nayak](https://handbook.gitlab.com/handbook/company/team/#knayakgl) | [Senior Backend Engineer, Git](https://handbook.gitlab.com/job-families/engineering/development/backend/#git)  
[![Patrick Steinhardt](https://about.gitlab.com/images/team/patricksteinhardt-crop.jpg)Patrick Steinhardt](https://handbook.gitlab.com/handbook/company/team/#pks-gitlab) | [Acting Engineering Manager, Git](https://handbook.gitlab.com/job-families/engineering/development/backend/manager/)  
[![Toon Claes](https://about.gitlab.com/images/team/toon-crop.jpg)Toon Claes](https://handbook.gitlab.com/handbook/company/team/#toon) | [Senior Backend Engineer, Git](https://handbook.gitlab.com/job-families/engineering/development/backend/#git)  
* * *
#####  [Database Help Workflow](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/data-access/help/)
A basic workflow for requesting help during database related incidents or emergencies
Last modified January 14, 2026: [Remove references to the outdated Category Maturity concept (`49bdccb8`)](https://gitlab.com/gitlab-com/content-sites/handbook/commit/49bdccb8)
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/infrastructure-platforms/data-access/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/infrastructure-platforms/data-access/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)