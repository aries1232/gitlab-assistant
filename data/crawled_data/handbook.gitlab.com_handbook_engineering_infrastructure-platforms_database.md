...
Visibility: Audit 
## Database Reliability at GitLab[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#database-reliability-at-gitlab)
...
## Database SLOs[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#database-slos)
We use [Service Level Objects](https://en.wikipedia.org/wiki/Service_level_objective) (SLOs) to reason about the performance and reliability aspects of the database. We think of SLOs as “commitments by the architects and operators that guide the design and operations of the system to meet those commitments.”[1](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#fn:1)
### Backup and Recovery[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#backup-and-recovery)
...
The backup strategy is to take a daily snapshot of the full database (basebackup) and store this in Google Cloud Storage. Additionally, we capture the write-ahead log data in GCS to be able to perform point-in-time recovery (PITR) using one of the basebackups. [Read more on Disaster Recovery](https://handbook.gitlab.com/handbook/engineering/gitlab-com/policies/disaster-recovery/)
...
### High Availability[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#high-availability)
For [GitLab.com we maintain availability](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/production/) above 99.95%. For the PostgreSQL database, we define the following SLOs:
...
## Common Links[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#common-links)
To make it easier to find your way around you can find a list of useful or important links below.
### Monitoring & Performance Related Tools[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#monitoring--performance-related-tools)
...
### Dashboards[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#dashboards)
...
### Documentation[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#documentation)
...
* * *
  1. From “Database Reliability Engineering”, O’Reilly Media, 2017 [↩︎](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/database/#fnref:1)
...
Visibility: Audit Moved to Disaster Recovery Policies for GitLab Backups 
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/infrastructure-platforms/database/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/infrastructure-platforms/database/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)