...
Any GitLab team-member can triage issues. Keeping the number of [un-triaged issues](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#triaging-issues) low is essential for maintainability, and is our collective responsibility.
...
## Accountability[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#accountability)
...
Our defect SLA can be viewed at:
  * [Priority labels](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#priority)
  * [Severity labels](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#severity)
...
## Label renaming[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#label-renaming)
...
## Auto-labelling of issues and merge requests[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#auto-labelling-of-issues-and-merge-requests)
...
The following logic was initially implemented in [this merge request](https://gitlab.com/gitlab-org/quality/triage-ops/merge_requests/155#workflow):
```
...
Group has  
one category?
Group is detected based on category labels  
with a match rate > 50% among  
all category labels?
Set category label.
Nothing to do.
Does detected group label  
matches stage label?
...
Check out the [list of actual use-cases](https://gitlab.com/gitlab-org/quality/triage-ops/merge_requests/155#test-cases) to better understand what this flow means in practice.
...
## Triage reports[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#triage-reports)
A [triage report](https://gitlab.com/gitlab-org/quality/team-tasks/issues/35) is an issue containing a checklist of issues or merge requests requiring attention. Usually, each task corresponds to an issue or a merge request that needs labels, prioritization, scheduling, attention etc. Some reports also include heatmaps or other various information.
Triage report are automatically assigned to specific team members, listed in [the stages definition file](https://gitlab.com/gitlab-com/www-gitlab-com/-/blob/master/data/stages.yml).
To change who an issue gets assigned to, open a merge request for the above files. If the group definition file is changed, we’ll need to [run some scripts](https://gitlab.com/gitlab-org/quality/triage-ops#generating-policy-files-and-ci-jobs) to update the generated files as well.
### Community-related triage reports[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#community-related-triage-reports)
These reports are owned by the [Developer Relations Engineering team](https://handbook.gitlab.com/handbook/marketing/developer-relations/engineering/).
#### Newly created community merge requests[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#newly-created-community-merge-requests)
This report contains community merge requests requiring [partial triage](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/merge-request-triage/#partial-triage-gitlab-org). The goal is for coaches to add type, stage, and group labels, so that the relevant people can be pinged later on based on these labels.
  * Frequency: Daily.
...
#### Community merge requests requiring attention[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#community-merge-requests-requiring-attention)
This report contains community merge requests that may require some attention from GitLab team members.
  * Frequency: Weekly.
  * Assignees: [Developer Relations Engineering team](https://handbook.gitlab.com/handbook/marketing/developer-relations/engineering/) + volunteer wider community members.
  * Listed merge requests (all awaiting GitLab response): 
    1. Merge requests from new contributors idle for 7 days.
    2. Merge requests idle for 21 days (excluding ~group::runner).
    3. ~group::runner merge requests idle for 21 days.
  * Triage action: 
...
### Team reports[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#team-reports)
#### Group level bugs, features, and Deferred UX[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#group-level-bugs-features-and-deferred-ux)
This report contains the relevant bugs, feature requests, and Deferred UX issues that belong to a group in our [DevOps stages](https://handbook.gitlab.com/handbook/product/categories/#devops-stages). The goal is to achieve [complete-triage](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#complete-triage) by the Product Manager, Engineering Manager, UX team member in that area.
...
![heatmap.png](https://handbook.gitlab.com/images/engineering/infrastructure-platforms/developer-experience/triage-operations/heatmap.png)
An example: <https://gitlab.com/gitlab-org/quality/triage-ops/issues/118>
Video overview of the triage report.
There is also an optional stage policy for [missing categories](https://gitlab.com/gitlab-org/quality/triage-ops/-/blob/master/policies/missing-categories.yml). If your team has enabled this, you will receive a list of up to 100 items that have the stage label but have zero appropriate category labels for that stage.
##### Feature proposals[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#feature-proposals)
...
##### Frontend bugs[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#frontend-bugs)
This section contains issues with the `~"type::bug"` and `~"frontend"` labels without priority and severity. It is divided further into issues with and without `~"customer"`
  ...
  * Triage actions: 
    ...
    2. Assign a [Priority Label](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#priority).
    3. Assign a [Severity Label](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#severity).
    4. Assign either a versioned milestone or to the `Backlog`.


##### Non-frontend bugs (likely backend)[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#non-frontend-bugs-likely-backend)
...
##### severity::1 & severity::2 bugs past SLO[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#severity1--severity2-bugs-past-slo)
This section contains bugs which has past our targeted SLO based on the severity label set. This is based on our [missed SLO detection](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#missed-slo) triage policy.
##### Heatmap for ~customer bugs[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#heatmap-for-customer-bugs)
...
#### Group level merge requests that may need attention[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#group-level-merge-requests-that-may-need-attention)
This report contains idle [group](https://handbook.gitlab.com/handbook/product/categories/) merge requests authored by GitLab team members.
...
#### Group level feature flags that may need attention[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#group-level-feature-flags-that-may-need-attention)
This report contains feature flags that have enabled in the codebase for 2 or more releases for groups within our [DevOps stages](https://handbook.gitlab.com/handbook/product/categories/#devops-stages).
...
#### Group level Bug Prioritization report[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#group-level-bug-prioritization-report)
This report contains [group](https://handbook.gitlab.com/handbook/product/categories/) level the Top 10 open issues of `~"type::bug"` which needs to be prioritized for the upcoming milestone. It is divided further into issues with `~"severity::`, `~"bug::vulnerability"` and `~"customer"` labels and listed based on the oldest age of the issues
  * Triage owner: Product Manager(s) and Engineering Manager(s) for that group.
  * Triage frequency: On 2nd of every month.
  * Triage actions: 
    1. Close the issue if it is no longer relevant or a duplicate.
    2. Prioritize these issues and identify the ones that needs to be picked into the upcoming milestone
    3. Assign either a versioned milestone or to the `Backlog`.
...
#### Auto closure of triage reports[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#auto-closure-of-triage-reports)
...
## Reactive workflow automation[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reactive-workflow-automation)
Reactive triage automation is complementary to scheduled triage automation where realtime feedback provides an improved developer experience. This is handled by [triage-ops](https://gitlab.com/gitlab-org/quality/triage-ops).
### Community-related reactive workflow automation[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#community-related-reactive-workflow-automation)
...
@gitlab-bot help
@gitlab-bot ready
Wider Community Merge request  
(author is not a member of `gitlab-org`)
Merge request with the `Community contribution` label
MR is opened
MR is updated
MR is merged
MR is closed
...
Anyone posts a note
1. Post a 'Thank you' note  
2. Add the `Community contribution` label  
3. Add the `workflow::in dev` label  
4. Assign MR to its author
Was the  
`workflow::ready for review`  
label added?
If reviewers are present, ask them to review.  
Otherwise, ask (and assign) an MR coach  
(selected based on group label) to review
Does the MR touches  
documentation files?
Post a note asking a  
technical writer to review
Does the MR has  
the `UX` label?
Post a message in the  
`#ux-community-contributions`  
Slack channel, and on the MR
Post a note asking  
for feedback
Is a Hackathon  
currently running?
Add the `Hackathon` label
What note is it?
What note is it?
Add the requested label
Ask (and assign as reviewer)  
an MR coach for help
Add the `workflow::ready for review` label
Post the feedback in the  
`#mr-feedback` Slack channel

```

#### Community contribution thank you note[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#community-contribution-thank-you-note)
  * Automation conditions: 
    * MR was opened
    * The MR is opened in a project under the `gitlab-org` group or for the `gitlab-com/www-gitlab-com` project, and its author is not present in the [team page](https://handbook.gitlab.com/handbook/company/team/)
  * Automation actions: 
...
#### Automated review request[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#automated-review-request)
  * Automation conditions: 
...
#### Automated review request for doc contributions[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#automated-review-request-for-doc-contributions)
  * Automation conditions: 
    * The `workflow::ready for review` label was added
    * The MR has the `Community contribution` label set
...
#### Automated review request for UX contributions[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#automated-review-request-for-ux-contributions)
  * Automation conditions: 
    * The `workflow::ready for review` label was added
    * The MR has the `Community contribution` label set
...
#### Reactive `help` command[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reactive-help-command)
  * Automation conditions: 
...
#### Reactive `ready` command[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reactive-ready-command)
  * Automation conditions: 
...
#### Reactive `unassign_review` command[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reactive-unassign_review-command)
  * Automation conditions: 
...
#### Reactive `label` and `unlabel` commands[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reactive-label-and-unlabel-commands)
  * Automation conditions: 
...
#### Idle/Stale label remover[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#idlestale-label-remover)
  * Automation conditions: 
...
#### Code Review Experience Feedback[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#code-review-experience-feedback)
  * Automation conditions: 
...
#### Reactive `feedback` command[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reactive-feedback-command)
  * Automation conditions: 
...
#### Leading Organizations labeler[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#leading-organizations-labeler)
  * Automation conditions: 
    * MR was opened or updated
    * The MR does not have the `Leading Organization` label set
    * The MR author is from a [leading organization](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#leading-organizations) based on the data we have on Sisense
  * Automation actions: 
...
#### Hackathon labeler[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#hackathon-labeler)
  * Automation conditions: 
...
#### Spam detector[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#spam-detector)
  * Automation conditions: 
  ...
  * Automation actions: 
    * Posts a note linking to [GitLab Website Terms of Use](https://handbook.gitlab.com/handbook/legal/policies/website-terms-of-use/)
...
### Engineering workflow automation[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#engineering-workflow-automation)
#### Ensure priorities for availability issues[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#ensure-priorities-for-availability-issues)
For issues labeled `~"availability"`, the minimal are enforced with the guidelines at <https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#availability-prioritization>
#### Ensure no deprecated backstage labels are added[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#ensure-no-deprecated-backstage-labels-are-added)
...
#### Add customer label whenever a customer associated link is added[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#add-customer-label-whenever-a-customer-associated-link-is-added)
...
#### Add type label from subtype[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#add-type-label-from-subtype)
Whenever a subtype label is added, the corresponding type label is added. Current type labels with subtype labels are:
  * `~"type::feature"`
  * `~"type::tooling"`


#### Merge request type label copy from related issues[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#merge-request-type-label-copy-from-related-issues)
  * Automation conditions: 
...
#### Reactive `retry_job` command[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reactive-retry_job-command)
  * Automation conditions: 
...
#### Reactive `retry_pipeline` command[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reactive-retry_pipeline-command)
  * Automation conditions: 
...
#### Reactive `delete_bot_comment` command[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reactive-delete_bot_comment-command)
  * Automation conditions: 
...
### Database-related reactive workflow automation[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#database-related-reactive-workflow-automation)
#### Database Review Experience Feedback[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#database-review-experience-feedback)
  * Automation conditions: 
    * MR was merged or closed
...
## Scheduled workflow automation[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#scheduled-workflow-automation)
Scheduled triage automation is run to label and update issues which help with reporting and milestone transition. This is handled by [triage-ops](https://gitlab.com/gitlab-org/quality/triage-ops).
### Community-related scheduled workflow automation[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#community-related-scheduled-workflow-automation)
#### Remove `Seeking community contributions` from issues with an assignee[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#remove-seeking-community-contributions-from-issues-with-an-assignee)
...
#### Remove `Seeking community contributions` from issues with an invalid workflow label[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#remove-seeking-community-contributions-from-issues-with-an-invalid-workflow-label)
...
#### Remove `Seeking community contributions` from all merge requests[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#remove-seeking-community-contributions-from-all-merge-requests)
...
#### Label community contributions[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#label-community-contributions)
Merge requests which have an author that is not a member of `gitlab-org` will have the `Community contribution` label applied. This scheduled automation is a backup for the reactive automation that applies `Community contribution` in the [welcome message](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#community-contribution-thank-you-note).
  * Automation conditions: 
...
#### Add milestone to community merge requests[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#add-milestone-to-community-merge-requests)
...
#### Label idle community merge requests[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#label-idle-community-merge-requests)
  * Automation conditions: 
...
#### Label stale community merge requests[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#label-stale-community-merge-requests)
  * Automation conditions: 
...
#### Nudge EMs on community merge requests that are `stale`[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#nudge-ems-on-community-merge-requests-that-are-stale)
  * Automation conditions: 
...
#### Nudge relevant coach on community merge requests that are waiting for a review[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#nudge-relevant-coach-on-community-merge-requests-that-are-waiting-for-a-review)
  * Automation conditions: 
...
#### Nudge assigned reviewers on community merge requests that are waiting for a review[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#nudge-assigned-reviewers-on-community-merge-requests-that-are-waiting-for-a-review)
  * Automation conditions: 
    * Merge request with the `Community contribution` and `workflow::ready for review` labels, and without the `automation:reviewers-reminded` label
...
### Engineering workflow automation[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#engineering-workflow-automation-1)
#### Milestone reschedule[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#milestone-reschedule)
...
**Note:** Confidential issues will be skipped as part of the `missed` label application. Please see the [this issue](https://gitlab.com/gitlab-org/quality/triage-ops/-/issues/45) for more information
  * Automation conditions: Open issues or merge requests that missed the current milestone, i.e. current date is `>= third Wednesday of the month`
  * Automation actions: 
...
#### Missed deliverable[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#missed-deliverable)
...
**Note:** Confidential issues will be skipped as part of the `missed` label application. Please see the [this issue](https://gitlab.com/gitlab-org/quality/triage-ops/-/issues/45) for more information
  * Automation conditions: 
    * Open issues or merge requests with the `~Deliverable` label and a `~missed:x.y` label, and no `~missed-deliverable` label.
  * Automation actions: 
    * The labels `~missed-deliverable` is applied.
  * Policy: <https://gitlab.com/gitlab-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/missed-resources.yml>


#### Deliverable with no milestone[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#deliverable-with-no-milestone)
...
#### Missed SLO[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#missed-slo)
Issues which have a severity label and missed the [SLO target](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#severity) will be labeled with `~missed-SLO`. The calculation for elapsed time starts from the date of the severity label was applied. This enables reporting on SLO target adherence.
  * Automation conditions: 
...
#### Bug priority label inference[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#bug-priority-label-inference)
...
#### Master broken categorization[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#master-broken-categorization)
...
#### Identify interesting feature proposals[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#identify-interesting-feature-proposals)
...
#### Auto-close inactive bugs[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#auto-close-inactive-bugs)
...
#### Prompt for Tier labels on issues[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#prompt-for-tier-labels-on-issues)
...
#### Prompt for Type labels on issues[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#prompt-for-type-labels-on-issues)
...
Type labels ensure that issues are present in the [group triage report](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#group-level-bugs-features-and-deferred-ux) and added to the correct section.
  * Automation conditions: 
...
##### Data[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#data)
...
#### Bug SLO Warning[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#bug-slo-warning)
Bugs have a severity label that indicates the [SLO for a fix](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#severity). This automated policy aims to prompt managers about bugs in their group that are approaching the SLO threshold
  * Automation conditions: 
...
#### Reminder on ~infradev issues to set severity label, priority label, and milestone[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reminder-on-infradev-issues-to-set-severity-label-priority-label-and-milestone)
Issues with the ~infradev label should have a [severity label](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#severity), a [priority label](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#priority), and a milestone set. This automated policy aims to prompt managers about such issues missing one of these attributes.
  * Automation conditions: 
...
#### Reminder on ~customer ~type::bug issues to set severity label[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#reminder-on-customer-typebug-issues-to-set-severity-label)
Issues with the ~customer and ~type::bug labels should have a [severity label](https://handbook.gitlab.com/handbook/product-development/how-we-work/issue-triage/#severity) set. This automated policy aims to prompt team members to set a severity so that ~customer bugs are triaged in a timely fashion.
  * Automation conditions: 
...
#### Post a note on new epics missing the type label[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#post-a-note-on-new-epics-missing-the-type-label)
...
## Resources[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#resources)
...
* * *
#####  [Issue Triage Onboarding](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/onboarding/)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)