# Infrastructure Platforms Department Request for Help Process
Infrastructure Platforms standardized approach to manage RFH issues.
## Background[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#background)
...
## Current Challenges[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#current-challenges)
...
## New Process Overview[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#new-process-overview)
### Philosophy[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#philosophy)
...
### Structure[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#structure)
...
## Process Rollout[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#process-rollout)
  1. Create a RFH Template with all the required information in your team’s or group’s repository.
  2. Create a Slack Workflow to route issues to your request tracker.
  3. Implement a triage process to deal with the incoming issues.
  4. Create a regular process to analyze the issues by fixing bugs, prioritizing projects, or creating documentation.
  5. Announce this broadly and encourage the team to use the emojis to route questions to the right place.


## Automation and Tools[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#automation-and-tools)
### Slack Workflow Emojis[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#slack-workflow-emojis)
...
![Example Slack Workflow](https://handbook.gitlab.com/images/engineering/infrastructure-platforms/production-engineering/example-slack-workflow.png)
### Issue Templates[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#issue-templates)
...
### Triage Bot Integration[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#triage-bot-integration)
...
### Analytics Dashboard[](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/request-for-help-processes/#analytics-dashboard)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/infrastructure-platforms/request-for-help-processes.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/infrastructure-platforms/request-for-help-processes.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)