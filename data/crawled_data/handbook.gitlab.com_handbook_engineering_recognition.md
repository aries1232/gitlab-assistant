...
## Engineering Quarterly Achievers[](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers)
Quarterly, CTO Leadership will recognize Engineering team members who have excelled in a given quarter. Winners are selected from nominations submitted by their peers. Winners are announced at the Engingeering All Hands. Recognition includes:
  * an invitation to the [Engineering Quarterly Achievers Chat](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers-chat)
  * participation in the [Engineering Quarterly Achiever’s Recognition Dinner](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers-recognition-dinner) - an expensed meal for yourself, friends and family to celebrate your work.


### Engineering Quarterly Achiever’s Chat[](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers-chat)
...
### Engineering Quarterly Achiever’s Recognition Dinner[](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers-recognition-dinner)
As part of this initiative, Engineering Quarterly Achievers are able to expense a meal up to $250.00 USD
The meal must occur and be expensed before the last day of the quarter following the announcement of their win. Each winner will be messaged individually by the program DRI Liki Simonot to let them know what is the last day of the quarter for expensing. Winners may submit their receipt for reimbursement via Navan.
Expensing Instructions:
  1. In Navan, click Add Transaction Select Upload receipt (or select Type in details)
  2. Under Expense Type field, please select “Team events & meals”
  3. Under Classification, please select “FY26 Team Building”
  4. Under Description field, please include this link: <https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers-recognition-dinner>
  5. Click Submit (or Save & close if you need to come back to add more information).


The $250.00 USD is reimbursable for a meal only, other items do not qualify.
### Engineering Quarterly Achievers Nominations[](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers-nominations)
Team members can nominate a peer for an award using [this submission form](https://forms.gle/CEBWJwgSNhp9PDi68) at any time. You may nominate as many people as you wish, provided the meet the selection criteria:
...
Add all relevant information to the text of your nomination – adding a link as SSOT is great, but ideally a nomination shouldn’t require clicking through to anything to be understood and evaluated. Be aware that the text (but not your name!) may be shared with the nominee.
### Winners Announcement[](https://handbook.gitlab.com/handbook/engineering/recognition/#winners-announcement)
Winners will be announced at the Engineering All Hands. The program DRI Liki Simonot will also reach out individually to each winner, providing details on the winners chat, and guidelines on when / how to expense their dinner. If a team member is on leave during this process, they can communicate with Liki on joining a future winners chat, and when to expense their meal.
### Categories[](https://handbook.gitlab.com/handbook/engineering/recognition/#categories)
In total, 15 team members from across the Engineering organization will be recognized. The categories by segment for FY26 include:
#### Engineering Efficiency[](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-efficiency)
  1. **Best Design Proposal Award** - awarded to individuals who submit well thought-out, technically-sound [architecture design document](https://handbook.gitlab.com/handbook/engineering/architecture/workflow/#design-documents) proposals on items that require cross-functional communication and influence
  ...
  4. **Proactive Avoidance Award** - awarded to individuals who raise concerns about things _before_ they become disastrous incidents
  5. **Security Improvement Award** - awarded to individuals who implement security features or defense in depth pattern to provide a more secure DevSecOps environment for everyone
  6. **Hiring Efficiency Award** - awarded to individuals who made a significant contribution to hiring efforts. This award is determined by interview data that is pulled by the recruiting team. If you would like to share your hiring observations for a nominee, you can send them to Jack Connors who will include your observations in the decision making process.


#### Engineering Excellence[](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-excellence)
...
#### Customer Results[](https://handbook.gitlab.com/handbook/engineering/recognition/#customer-results)
  ...
  4. **Contribution to Sales or Renewal Award** - awarded to an individual who assisted in quarterly revenue generating activity - _nominated by a member of Sales, CS or Renewals_


Categories are reevaluated by CTO leadership and changed as necessary.
## Engineering Quarterly Achievers Past Winners[](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers-past-winners)
These are the past award winners. The quarter indicated covers work completed that quarter.
### FY26-Q1[](https://handbook.gitlab.com/handbook/engineering/recognition/#fy26-q1)
Quarter | Category | Award | Winner  
---|---|---|---  
FY26-Q1 | Efficiency | Best Design Proposal | **Not Awarded**  
FY26-Q1 | Efficiency | Cost Savings | Dmitry Gruzd  
FY26-Q1 | Efficiency | Software Efficiency | Stanislav Lashmanov  
FY26-Q1 | Efficiency | Proactive Avoidance | Gregory Havenga  
FY26-Q1 | Efficiency | Security Improvement | Erran Carey  
FY26-Q1 | Efficiency | Hiring Efficiency | Tony Ganga  
FY26-Q1 | Excellence | Engineering Excellence | Ravi Kumar  
FY26-Q1 | Excellence | Excellence Under Pressure | **Not Awarded**  
FY26-Q1 | Excellence | Testing Excellence | **Not Awarded**  
FY26-Q1 | Excellence | Most Impactful MR or Doc Update | Terri Chu  
FY26-Q1 | Excellence | Everyone-can-contribute | **Not Awarded**  
FY26-Q1 | Customer Results | Customer Centered Individual | Donna Alexandra  
FY26-Q1 | Customer Results | Customer Kudos | **Not Awarded**  
FY26-Q1 | Customer Results | Performance and Scalability | Konst Tchernov  
FY26-Q1 | Customer Results | Contribution to Sales or Renewal | **Not Awarded**  
### FY25-Q4[](https://handbook.gitlab.com/handbook/engineering/recognition/#fy25-q4)
Quarter | Category | Award | Winner  
---|---|---|---  
...
### FY25-Q3[](https://handbook.gitlab.com/handbook/engineering/recognition/#fy25-q3)
Quarter | Category | Award | Winner  
---|---|---|---  
...
### FY25-Q2[](https://handbook.gitlab.com/handbook/engineering/recognition/#fy25-q2)
Quarter | Category | Award | Winner  
---|---|---|---  
...
### FY25-Q1[](https://handbook.gitlab.com/handbook/engineering/recognition/#fy25-q1)
Quarter | Category | Award | Winner  
---|---|---|---  
...
### FY24-Q4[](https://handbook.gitlab.com/handbook/engineering/recognition/#fy24-q4)
Quarter | Category | Award | Winner  
---|---|---|---  
...
### FY24-Q3[](https://handbook.gitlab.com/handbook/engineering/recognition/#fy24-q3)
Quarter | Category | Award | Winner  
---|---|---|---  
...
* * *
## Engineering Quarterly Achievers Process[](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers-process)
This process is followed by a delegate of the CTO Leads team
### Engineering Quarterly Achievers Timeline[](https://handbook.gitlab.com/handbook/engineering/recognition/#engineering-quarterly-achievers-timeline)
  1. Engineering Quarterly Achievers selected within the first week of the new quarter by CTO leadership
  2. Engineering Quarterly Achievers announced and recognized in the Engineering All-Hands
  3. Program DRI reaches out to all winners to share details of the winners chat and dinner.
  4. Engineering Quarterly Achievers Chat held within the quarter of announcement
  5. CTO and 2 E-Group Members congratulate and inquire about key learnings from achievers on call


### Communicating[](https://handbook.gitlab.com/handbook/engineering/recognition/#communicating)
...
### Selecting Winners[](https://handbook.gitlab.com/handbook/engineering/recognition/#selecting-winners)
...
### Announce Winners[](https://handbook.gitlab.com/handbook/engineering/recognition/#announce-winners)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/recognition.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/recognition.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)