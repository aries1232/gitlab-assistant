...
## Role of the SME[](https://handbook.gitlab.com/handbook/engineering/tax-credits/#role-of-the-sme)
...
### Time-spend calculation[](https://handbook.gitlab.com/handbook/engineering/tax-credits/#time-spend-calculation)
...
That can be done by engaging with managers of those team-members. However, this is time-consuming and some basic heuristics can be used to create sensible defaults:
  * **Engineers** who spent the full year in the role will typically have a high level of time-spend. Since almost all GitLab categories [qualify](https://handbook.gitlab.com/handbook/engineering/tax-credits/#qualifying-rd-projects), as “R&D”, and feature, bug, maintenance and code review work contributes to these, the majority of their time will qualify also. It’s not unusual to see time-spend at 95% for engineers, with 5% removed for training and mentoring.
...
### Qualifying R&D Projects[](https://handbook.gitlab.com/handbook/engineering/tax-credits/#qualifying-rd-projects)
...
GitLab’s standard process for [product development](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/) meets the criteria in most cases. As a result, it is typically _not_ necessary to compile a list of R&D projects worked on. Instead you can use a summary of Release notes as the list of R&D projects, and set team member allocations based on their participation in GitLab’s standard process for [product development](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/).
...
### Precedents[](https://handbook.gitlab.com/handbook/engineering/tax-credits/#precedents)
...
Last modified July 2, 2025: [Add product dev folder and move relevant pages (`83bfc789`)](https://gitlab.com/gitlab-com/content-sites/handbook/commit/83bfc789)
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/tax-credits.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/tax-credits.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)