...
## Description[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#description)
...
## Approach[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#approach)
Observability testing is actively making use of our [Observability tools](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#tools-and-technologies) to detect trends that would develop into performance issues. A couple common approaches:
...
## Key Components[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#key-components)
...
## Goals[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#goals)
...
## Non-Goals[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#non-goals)
...
## Implementation Approach[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#implementation-approach)
### Phase 1: Foundation Setting[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#phase-1-foundation-setting)
...
### Phase 2: Initial Implementation[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#phase-2-initial-implementation)
  1. Team Selection 
...
### Phase 3: Practice and Culture Building[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#phase-3-practice-and-culture-building)
  1. Expand to Early Adopters
  2. Process Integration 
     * Document how to use in GitLab Dev workflows


### Phase 4: Expansion and Maturity[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#phase-4-expansion-and-maturity)
...
## Case Studies[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#case-studies)
### Case Study 1: Scrum team using Observability Based Performance Testing[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#case-study-1-scrum-team-using-observability-based-performance-testing)
#### Background[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#background)
...
#### Observability implementation[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#observability-implementation)
...
#### Daily Workflow[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#daily-workflow)
...
#### Implementation Challenges[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#implementation-challenges)
...
#### Outcomes[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#outcomes)
...
## Tools and Technologies[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#tools-and-technologies)
  * Prometheus
  * Grafana
  * [Add other relevant tools used at GitLab]


## Future Directions[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#future-directions)
[TBD]
## Resources[](https://handbook.gitlab.com/handbook/engineering/testing/observability_performance/#resources)
...
Last modified June 30, 2025: [Fix link typo in Eng./Observability Performance (`ae6099ec`)](https://gitlab.com/gitlab-com/content-sites/handbook/commit/ae6099ec)
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/testing/observability_performance.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/testing/observability_performance.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)