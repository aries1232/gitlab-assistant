# Pipeline DRI On-call Rotation
The Developer Experience Sub-Department has two on-call rotations: pipeline triage (SET-led) and incident management (EM-led).
## Developer Experience Sub-Department pipeline triage on-call rotation[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#developer-experience-sub-department-pipeline-triage-on-call-rotation)
This is a schedule to share the responsibility of debugging/analysing the failures in the various scheduled pipelines that run on multiple environments. Developer Experience sub-department’s on-call does not include work outside GitLab’s normal business hours. Weekends and [Family and Friends Days](https://handbook.gitlab.com/handbook/company/family-and-friends-day/) are excluded as well. SETs also have full autonomy to move their 1:1s and their attendance to department meetings asynchronous for the week of their oncall if they decide to do so but please communicate to your manager accordingly.
...
Please refer to the [Debugging Failing tests](https://docs.gitlab.com/development/testing_guide/end_to_end/debugging_end_to_end_test_failures/) guidelines for an exhaustive [list of scheduled pipelines](https://handbook.gitlab.com/handbook/engineering/testing/end-to-end-pipeline-monitoring/) and for [specific instructions on how to do an appropriate level of investigation and determine next steps for the failing test](https://handbook.gitlab.com/handbook/engineering/testing/pipeline-triage/).
### Responsibility[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#responsibility)
#### Triage, record, and unblock failures[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#triage-record-and-unblock-failures)
...
### Schedule[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#schedule)
...
### Responsibilities of the DRI for scheduled pipelines[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#responsibilities-of-the-dri-for-scheduled-pipelines)
  * The DRI does the [triage](https://handbook.gitlab.com/handbook/engineering/testing/pipeline-triage/). They should solicit help in the `#s_developer_experience` slack channel if they need further assistance.
...
### Responsibilities of the DRI for deployment pipelines[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#responsibilities-of-the-dri-for-deployment-pipelines)
...
### New hire on-call shadowing[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#new-hire-on-call-shadowing)
...
### Supporting infrastructure and environment upgrades[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#supporting-infrastructure-and-environment-upgrades)
...
For teams requesting upgrade support (within or outside office hours):
  ...
  3. What to expect after the request was submitted?
...
NOTE! We don’t have many team members in APAC area, so sometimes there will be an empty window of 4 hours during which we kindly ask you to use our troubleshooting guides:
  * [Using Duo to debug test failures](https://handbook.gitlab.com/handbook/engineering/testing/using-duo-to-debug-test-failures/)
  * [Guide to E2E test failure issues](https://handbook.gitlab.com/handbook/engineering/testing/guide-to-e2e-test-failure-issues/)
...
## Developer Experience Sub-Department incident management on-call rotation[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#developer-experience-sub-department-incident-management-on-call-rotation)
The EMs should share the responsibility of monitoring, responding to, and mitigating incidents. Developer Experience Sub-Department’s on-call does not include work outside GitLab’s normal business hours. Weekends and [Family and Friends Days](https://handbook.gitlab.com/handbook/company/family-and-friends-day/) are excluded as well. In the current iteration, incident management activities happen during each team member’s working hours.
### Responsibility[](https://handbook.gitlab.com/handbook/engineering/testing/oncall-rotation/#responsibility-1)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/testing/oncall-rotation.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/testing/oncall-rotation.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)