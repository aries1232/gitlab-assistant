...
## Overview[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#overview)
...
## Environment Catalog[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#environment-catalog)
### Staging-Canary[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#staging-canary)
...
[More details about Staging-Canary](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/#staging-canary)
* * *
### Staging[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#staging)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
...
**Access:**
You may already have an account since Production accounts are automatically brought to Staging. Create an access request in the [access-request project](https://gitlab.com/gitlab-com/team-member-epics/access-requests) and assign to your manager for approval.
[More details about Staging](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/#staging)
* * *
### Staging-Ref[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#staging-ref)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
...
[More details about Staging Ref](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/staging-ref/)
* * *
### Production-Canary[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#production-canary)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
...
[More details about Production-Canary](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/#production-canary)
* * *
### Production[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#production)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
...
[More details about Production](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/#production)
* * *
### .org (dev.gitlab.org)[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#org-devgitlaborg)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
Permanent | Active | GitLab.com | [dev.gitlab.org](https://dev.gitlab.org) | Infrastructure Team | [Infrastructure Environments](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/) | Production and build team  
...
[More details about .org](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/#org)
* * *
### Ops (ops.gitlab.net)[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#ops-opsgitlabnet)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
Permanent | Active | GitLab.com | [ops.gitlab.net](https://ops.gitlab.net) | Infrastructure Team | [Infrastructure Environments](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/) | SREs  
**Purpose:** GitLab.com operations infrastructure. Holds all infrastructure critical for managing GitLab.com.
[More details about Ops](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/#ops)
**Key Features:**
  * Not intended for testing purposes
  * Mission critical instance for builds and infrastructure
...
* * *
### Pre[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#pre)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
...
[More details about Pre](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/#pre)
* * *
### Release[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#release)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
[More details about Release](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/environments/#release)
* * *
### Release Environments[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#release-environments)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
* * *
### Dedicated Test Sandbox[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#dedicated-test-sandbox)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
[Support Handbook](https://handbook.gitlab.com/handbook/support/workflows/dedicated/#test-and-reproduction-on-gitlab-dedicated-instance)
* * *
### Dedicated Instrumentor Review Apps[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#dedicated-instrumentor-review-apps)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
* * *
### Dedicated UAT[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#dedicated-uat)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
* * *
### Reference Architecture Tester (RAT)[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#reference-architecture-tester-rat)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
#### FIPS Testing[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#fips-testing)
...
* * *
### GitLab Sandbox Cloud[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#gitlab-sandbox-cloud)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
Ephemeral | N/A | Self-managed | `*.gitlabsandbox.cloud` | [In Transition to Infrasec](https://gitlab.com/gitlab-com/gl-security/corp/issue-tracker/-/work_items/2356) | [GitLab Sandbox Cloud](https://handbook.gitlab.com/handbook/company/infrastructure-standards/realms/sandbox/) | All engineers  
...
[Support Workflows](https://handbook.gitlab.com/handbook/support/workflows/test_env/)
* * *
### CustomersDot Staging[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#customersdot-staging)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
[CustomersDot Architecture](https://gitlab.com/gitlab-org/customers-gitlab-com/-/tree/main/doc/architecture#customersdot) [CustomersDot environment mappings](https://gitlab.com/gitlab-org/customers-gitlab-com/-/blob/main/doc/environment_mapping.md)
* * *
### Test-on-CNG[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#test-on-cng)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
...
* * *
### Test-on-GDK[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#test-on-gdk)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
...
* * *
### Test-on-Omnibus[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#test-on-omnibus)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
* * *
### Charts Review Apps[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#charts-review-apps)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
...
* * *
### Operator Review Apps[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#operator-review-apps)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
...
* * *
### Upgrade Tester[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#upgrade-tester)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
* * *
### Backup & Restore Testing[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#backup--restore-testing)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
* * *
### UX Cloud Sandbox[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#ux-cloud-sandbox)
Type | Status | Platform | URL | Owner/DRI | Project | Cells | Access  
---|---|---|---|---|---|---|---  
Permanent | Active | Self-Managed | <https://ux.gitlabdemo.cloud/> | UX Team | [UX Research](https://handbook.gitlab.com/handbook/product/ux/experience-research/ux-cloud-sandbox/) | Not Enabled | Contact UX team  
...
* * *
### Support GET Template[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#support-get-template)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
* * *
### Performance Test RFH Environments[](https://handbook.gitlab.com/handbook/engineering/testing/test-environments-catalog/#performance-test-rfh-environments)
Type | Status | Platform | URL | Owner/DRI | Project | Access  
---|---|---|---|---|---|---  
...
* * *
_Related Epic:[Understanding Test Environments](https://gitlab.com/groups/gitlab-org/quality/-/epics/262)_
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/testing/test-environments-catalog.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/testing/test-environments-catalog.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)