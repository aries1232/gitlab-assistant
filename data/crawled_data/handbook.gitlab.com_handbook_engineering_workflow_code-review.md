...
## Overview[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#overview)
...
These guidelines also describe who would need to review, approve and merge your, or a community member’s, merge request. They also describe the [review response time SLO’s](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#review-response-slo) team members have to abide by.
## Values[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#values)
Every reviewer at GitLab must strive for our [reviewer values](https://handbook.gitlab.com/handbook/engineering/workflow/reviewer-values/).
...
You can find someone to review your merge requests by looking on the [team page](https://handbook.gitlab.com/handbook/company/team/), or on the list of [GitLab Engineering Projects](https://handbook.gitlab.com/handbook/engineering/projects/), both of which are fed by YAML files under `data/team_members/person/*`.
You can also help community contributors get their merge requests ready, by becoming a [Merge Request Coach](https://handbook.gitlab.com/job-description-library/expert/merge-request-coach/).
...
### Managing Review Assignments Before PTO[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#managing-review-assignments-before-pto)
Before taking paid time off, reviewers should:
  * Check all MR reviews assigned to you on your last working day before PTO
  * Respect the [review SLO](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#review-response-slo) by either: 
...
Maintainers are GitLab engineers who are experts at code review, know the GitLab product and codebase very well, and are empowered to accept merge requests in one or several [GitLab Engineering Projects](https://handbook.gitlab.com/handbook/engineering/projects/).
...
As with regular reviewers, maintainers can be found on the [team page](https://handbook.gitlab.com/handbook/company/team/), or on the list of [GitLab Engineering Projects](https://handbook.gitlab.com/handbook/engineering/projects/).
### Senior+ Maintainers[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#senior-maintainers)
For senior+ engineers, being a maintainer is part of their job family unless they have discussed with their manager or Team Member Relations in line with our [reasonable accommodation process](https://handbook.gitlab.com/handbook/people-policies/inc-usa/#reasonable-accommodation). Any of the [engineering projects](https://handbook.gitlab.com/handbook/engineering/projects/) considered as part of the product are suitable, provided the individual has been a contributor and an active reviewer of the project. Effective 2022-08-01, we use the following table for the timeframe expectations of maintainership:
...
### Meeting the reviewer/maintainer[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#meeting-the-reviewermaintainer)
...
### How to become a project maintainer[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#how-to-become-a-project-maintainer)
...
#### Maintainership check-ins and mentorship[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainership-check-ins-and-mentorship)
Interested reviewers should check in regularly with their manager/mentor to discuss progress towards maintainership and review any recent detailed reviews, for example during their 1-on-1s. Reviewers are encouraged to also seek out a [maintainer mentor](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#reviewer-mentorship-program) for further perspective on their reviews. Reviewers are encouraged to think of their eligibility for maintainership in the terms of “I could be ready at any time to be a maintainer as long as it is justified”.
...
#### Merge request feedback for reviewers[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#merge-request-feedback-for-reviewers)
...
#### Maintainership nomination process[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainership-nomination-process)
...
#### Pre-requesites for Maintainership[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#pre-requesites-for-maintainership)
...
#### Request Maintainership feedback[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#request-maintainership-feedback)
Before merging, the manager/mentor should:
  1. Mention the maintainers from the given specialty and ask them to provide feedback to the manager/mentor directly. Emphasize that any negative feedback should be communicated privately to the manager/mentor, not in the merge request. This is inline with our Collaboration value that [Negative feedback is 1-1](https://handbook.gitlab.com/handbook/values/#negative-feedback-is-1-1). Refer to the additional guidance for [managing negative feedback](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#managing-negative-feedback).
...
##### Managing negative feedback[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#managing-negative-feedback)
...
The manager/mentor should seek to understand any concern raised by a current maintainer when they disagree with a trainee maintainer’s readiness or qualifications. Use the following guidelines to determine if a single disapproval should veto approvals received in favor of the trainee maintainer.
  ...
  4. the trainee maintainer consistently does not perform [MR reviews in a conventional manner](https://docs.gitlab.com/ee/development/code_review.html#reviewing-a-merge-request), or
  5. the trainee maintainer has consistently been irresponsible in ensuring our [code quality and standards](https://handbook.gitlab.com/handbook/engineering/development/principles/#code-quality-and-standards) as isolated incidents are expected in the training process.
...
#### Maintainership approval[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainership-approval)
After merging, the manager should:
  1. Announce this change in the applicable channels listed under [Slack section of the engineering communications handbook](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#slack) and `#backend_maintainers`/`#frontend_maintainers` and `#backend`/`#frontend`.
...
### Additional steps for approved project maintainers[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#additional-steps-for-approved-project-maintainers)
Interested reviewers for the projects below should complete the listed tasks in addition to what is described in [How to become a project maintainer](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#how-to-become-a-project-maintainer) to progress from a reviewer to a maintainer.
#### Project maintainer process for `gitlab-rails`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for--gitlab-rails)
...
#### Project maintainer process for `gitlab-database`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-database)
...
Tips:
  * If you’d like a dashboard limited to just reviews where you applied the `~"database::reviewed"` label, reach out to the database group manager to get one.


#### Project maintainer process for `gitlab-components`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-components)
...
#### Project maintainer process for `design.gitlab.com` or `gitlab-svgs`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-designgitlabcom-or-gitlab-svgs)
[`design.gitlab.com`](https://gitlab.com/gitlab-org/gitlab-services/design.gitlab.com) or [`gitlab-svgs`](https://gitlab.com/gitlab-org/gitlab-svgs)
  * Understand [how to become a maintainer](https://handbook.gitlab.com/handbook/product/ux/pajamas-design-system/design-review/#how-to-become-a-maintainer).
  * All designers are maintainers of [`gitlab-design`](https://gitlab.com/gitlab-org/gitlab-design) project. If you are interested in becoming a Maintainer of UI (`.scss`) for `gitlab`, and `gitlab-ui` projects, please follow the [Engineering Review Workflow](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/).
  ...
  * As maintainer, you must keep [relying on others](https://handbook.gitlab.com/handbook/values/#its-impossible-to-know-everything) for the expertise they have that you don’t. In the MR description, highlight the efforts that showcase your results at a maintainer-level, what skills you want to continue working on, and add a link to this issue. ([Example](https://gitlab.com/gitlab-org/gitlab-services/design.gitlab.com/-/merge_requests/2395)).


#### Project maintainer process for `gitlab-quality`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-quality)
...
#### Project maintainer process for `gitlab-secure-analyzers`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-secure-analyzers)
[`gitlab-secure-analyzers`](https://gitlab.com/gitlab-org/security-products/analyzers)
  ...
  * Understand our [Secure QA Process](https://handbook.gitlab.com/handbook/engineering/development/sec/secure/qa_process/).


#### Project maintainer process for `gitlab-elasticsearch-indexer`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-elasticsearch-indexer)
[`gitlab-elasticsearch-indexer`](https://gitlab.com/gitlab-org/gitlab-elasticsearch-indexer)
  ...
  * _Optional:_ Reach out to an [existing maintainer](https://gitlab.com/gitlab-org/gitlab-elasticsearch-indexer/-/project_members?with_inherited_permissions=exclude) to [help you become](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#how-to-become-a-project-maintainer) a maintainer.


#### Project maintainer process for `customers-gitlab-com`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-customers-gitlab-com)
...
#### Project maintainer process for `gitlab-secure-license-db`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-secure-license-db)
...
#### Project maintainer process for `gitlab-chart`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-chart)
[`gitlab-chart`](https://gitlab.com/gitlab-org/charts/gitlab)
  * Familiarize yourself with [Distribution’s merge request workflow](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/gitlab-delivery/distribution/merge_requests/#workflow)
...
#### Project maintainer process for `gitlab-operator`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-operator)
...
#### Project maintainer process for `ai-gateway`[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#project-maintainer-process-for-ai-gateway)
[`ai-gateway`](https://gitlab.com/gitlab-org/modelops/applied-ml/code-suggestions/ai-assist)
  * Understand the [software architecture](https://handbook.gitlab.com/handbook/engineering/architecture/design-documents/ai_gateway/).
  ...
  * Read through [Maintainership documentation](https://gitlab.com/gitlab-org/modelops/applied-ml/code-suggestions/ai-assist/-/blob/main/docs/maintainership.md) and follow the steps outlined there to become a maintainer.


#### Learning to be a maintainer[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#learning-to-be-a-maintainer)
...
#### After becoming a maintainer[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#after-becoming-a-maintainer)
...
### Reviewer mentorship program[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#reviewer-mentorship-program)
...
#### Structure[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#structure)
  ...
  3. Mentor / reviewer assignments are coordinated within a [maintainer_mentorship.yml](https://gitlab.com/gitlab-com/www-gitlab-com/-/blob/master/data/maintainer_mentorship.yml) file.
  4. New reviewers need to locate an existing maintainer that has an opening available in [maintainer_mentorship.yml](https://gitlab.com/gitlab-com/www-gitlab-com/-/blob/master/data/maintainer_mentorship.yml) and contact the maintainer directly.
  ...
  9. Make sure to remove graduated reviewers from the [maintainer_mentorship.yml](https://gitlab.com/gitlab-com/www-gitlab-com/-/blob/master/data/maintainer_mentorship.yml) file to make space for new mentees.


#### Benefits[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#benefits)
...
##### Transitioning away from being a reviewer/maintainer[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#transitioning-away-from-being-a-reviewermaintainer)
After consultation with your manager, you may wish or need to transition away from being a reviewer/maintainer. Regardless of the circumstances, it’s perfectly OK for this to happen! Responsibilities and workloads change; projects evolve. So it’s important to ensure your time is spent on the areas that are most important. To make the change official and to be removed from [reviewer roulette](https://docs.gitlab.com/ee/development/code_review.html#reviewer-roulette):
  1. See the [Team Member Database](https://gitlab.com/gitlab-com/www-gitlab-com/-/blob/master/doc/team_database.md) document for how to update your YAML file.
  2. Create a new MR and assign the MR to your manager.


##### Returning to become a reviewer/maintainer[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#returning-to-become-a-reviewermaintainer)
After a period of transitioning away from being a reviewer/maintainer, you may wish to return to performing these duties. To make the request official, see the section on [how to become a project maintainer](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#how-to-become-a-project-maintainer), creating the tracking issue and Merge Request, referencing previous tracking issue(s) and Merge Request(s) for context. The newly created Merge Request should be assigned to your manager for immediate review as the process can usually be fast tracked.
### Maintainership process for smaller projects[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainership-process-for-smaller-projects)
...
Projects may adopt these guidelines for maintainership to help grow maintainers in projects where there are not enough maintainers.
  * All team members should consult the [engineering development roles](https://handbook.gitlab.com/job-description-library/engineering/development/) and become a reviewer or maintainer.
  * Add a project specific maintainer process under [How to become a project maintainer](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#how-to-become-a-project-maintainer). A [lightweight template](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainer-process-template) is provided.
...
#### Accelerated maintainer onboarding for smaller projects[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#accelerated-maintainer-onboarding-for-smaller-projects)
...
#### Maintainer process template[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainer-process-template)
Use this lightweight template as a starting point for defining your project’s maintainer requirements.
  ...
  * _Optional:_ Reach out to an existing maintainer to [help you become](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#reviewer-mentorship-program) a maintainer.


### Maintainer ratios[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainer-ratios)
...
### Maintainer Demand[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainer-demand)
...
#### About this dashboard[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#about-this-dashboard)
Definitions of metrics:
  ...
  * Monthly Review Target - A variable number based on the expected number of reviews per maintainer in a given month. Monthly review targets can be custom based on the area, or generally defined based on the number of Incoming Merge Requests. For more information on this metric, [read below](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#monthly-review-targets).
...
#### Monthly Review Targets[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#monthly-review-targets)
...
#### Caveats[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#caveats)
...
### Maintainer/Reviewer Availability[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainerreviewer-availability)
...
## Leading Organizations[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#leading-organizations)
All wider community members, and their organizations, [can contribute](https://handbook.gitlab.com/handbook/company/mission/#contribute-with-gitlab). We strongly believe that contributing to open source, and particularly to GitLab is a competitive advantage for organizations and their members, and want to reward those organizations for doing so. GitLab highly encourages, celebrates & rewards those that contribute in [frequent and atomic iterations](https://handbook.gitlab.com/handbook/values/#iteration). When an organization or individual without affiliations reaches 20 merged merge requests or more within the last 3 completed months, we consider that organization or individual a `Leading Organization`.
Organizations are matched based on the `Organization` field in [your profile](https://gitlab.com/-/profile). GitLab can also match individuals to organizations using other metadata available to the Contributor Success team. [Create an issue in the Contributor Success queue](https://gitlab.com/gitlab-com/quality/contributor-success/-/issues) if you think you or your organization should qualify but is not receiving the label `Leading Organization` on your merge requests.
A `Leading Organization` is entitled to a [review response SLO](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#review-response-slo). This entitlement will be awarded in the beginning of each month. Merge requests that were created during the time in which an organization is entitled to the `Leading Organization` status, will receive the label `Leading Organization`.
...
## Domain Experts[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#domain-experts)
...
### What makes a domain expert?[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#what-makes-a-domain-expert)
...
### How to self-identify as a domain expert[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#how-to-self-identify-as-a-domain-expert)
The only requirement to be considered a domain expert is to have substantial experience with a specific technology, product feature or area of the codebase. We leave it up to the team member to decide whether they meet this criteria.
  ...
  2. Update your entry in your own [YAML file](https://gitlab.com/gitlab-com/www-gitlab-com/-/tree/master/data/team_members/person) with a new `domain_expertise` property and list all domain expertise keys.
...
### Where can I find a list of people with domain expertise?[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#where-can-i-find-a-list-of-people-with-domain-expertise)
The expertise of a team member can be seen on the [Engineering Projects](https://handbook.gitlab.com/handbook/engineering/projects/) page.
## Review turnaround time[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#review-turnaround-time)
Because [unblocking others is always a top priority](https://handbook.gitlab.com/handbook/values/#iteration), reviewers are expected to review merge requests in a timely manner, even when this may negatively impact their other tasks and priorities.
...
To ensure swift feedback to ready-to-review code, we maintain a `Review-response` Service-level Objective (SLO). The SLO applies to GitLab team members and [Leading Organizations](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#leading-organizations), but not to other wider community contributors.
...
The SLO value depends on the author of the merge request:
  ...
  * From authors of [Leading Organizations](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#leading-organizations): `Review-response` SLO < 4 business days
...
Reviewers may also communicate their status through the use of several other emoji. For more details on these other statuses, please refer to the [code review](https://docs.gitlab.com/ee/development/code_review.html#reviewer-roulette) page in the developer documentation.
Of course, if you are out of office and have [communicated](https://handbook.gitlab.com/handbook/people-group/time-off-and-absence/time-off-types/) this through your GitLab.com Status, authors are expected to realize this and find a different reviewer themselves.
...
### Managing expectation[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#managing-expectation)
...
## Code Owner approvals[](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#code-owner-approvals)
...
There are two ways to update the Code Owner(s) of the `CODEOWNERS` file:
  1. Update the membership of a group that already has the ability to approve CODEOWNERS changes via the [standard access request process](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/).
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/workflow/code-review.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/workflow/code-review.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)