...
### Overview[](https://handbook.gitlab.com/handbook/engineering/workflow/cross-functional-prioritization/#overview)
...
—AND—  
Bugs including severity-based SLAs | 40%  
...
#### Cross-functional milestone planning[](https://handbook.gitlab.com/handbook/engineering/workflow/cross-functional-prioritization/#cross-functional-milestone-planning)
...
For more details on these three work types, please see the section on [work type classification](https://handbook.gitlab.com/handbook/product/groups/product-analysis/engineering/metrics/#work-type-classification). The development EM is the DRI to ensure that the merge requests are accurately labeled.
#### Prioritization and DRI by Component[](https://handbook.gitlab.com/handbook/engineering/workflow/cross-functional-prioritization/#prioritization-and-dri-by-component)
Our backlog should be prioritized on an ongoing basis. Prioritization will be done via team planning (collaboration between product, development, UX) with PM as the DRI for the milestone plan. PMs, EMs, and UX will provide the following:
  ...
  2. Engineering Manager (EM) in development provides prioritized `~"type::bug"` based on [bug prioritization](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/bug-prioritization/) and `~"type::maintenance"` issues, including [reducing technical debt](https://handbook.gitlab.com/handbook/engineering/workflow/#technical-debt)


_Note: UX-related work items would be prioritized in accordance with the appropriate sub-types. UX related bugs are included in the automated process (S1/2 and so on), UX-related maintenance items will be included in the EM’s prioritized list, Product (feature) UX items will have been included as part of our normal[Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/)._
...
#### Features and future plans[](https://handbook.gitlab.com/handbook/engineering/workflow/cross-functional-prioritization/#features-and-future-plans)
...
#### Milestone planning and prioritization[](https://handbook.gitlab.com/handbook/engineering/workflow/cross-functional-prioritization/#milestone-planning-and-prioritization)
Teams should follow the standard milestone planning process as described in our [Product Development Flow](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/#build-track). PMs will keep the overall prioritized backlog following the agreed-upon ratios and guidance from their EM, and UX counterparts.
#### Review and monitoring team health[](https://handbook.gitlab.com/handbook/engineering/workflow/cross-functional-prioritization/#review-and-monitoring-team-health)
...
##### Example questions to ask as stable counterparts review team health[](https://handbook.gitlab.com/handbook/engineering/workflow/cross-functional-prioritization/#example-questions-to-ask-as-stable-counterparts-review-team-health)
Context:
...
Trends:
  ...
  3. Compare the planned milestone with the previous months [merge request trends](https://10az.online.tableau.com/t/gitlab/views/DRAFTMergeRequestTypes/MergeRequestTypes) for the team. Any trends to note?
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/workflow/cross-functional-prioritization.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/workflow/cross-functional-prioritization.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)