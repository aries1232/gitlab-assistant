...
## About This Page[](https://handbook.gitlab.com/handbook/engineering/workflow/development-processes/rollout-plans/#about-this-page)
This page outlines the requirements, success criteria, and how-to’s of a rollout plan within the Development department.
### What is a rollout plan and why do you need one?[](https://handbook.gitlab.com/handbook/engineering/workflow/development-processes/rollout-plans/#what-is-a-rollout-plan-and-why-do-you-need-one)
...
### Creating a rollout plan[](https://handbook.gitlab.com/handbook/engineering/workflow/development-processes/rollout-plans/#creating-a-rollout-plan)
...
Here are some things to consider including in your rollout plan:
  ...
  2. Metrics to observe 
     * Provide links to data that can be monitored to understand whether your expectations are being met. Data could be based on predefined searches from tools like Sentry, Sitespeed, Grafana, Kibana, or some of our other [monitoring tools](https://handbook.gitlab.com/handbook/engineering/monitoring/#monitoring).
  3. Testing scenarios 
  ...
  4. Communication 
     * Include a communication plan that includes relevant stakeholders - such as other stage groups, departments, or by [engaging with Support](https://handbook.gitlab.com/handbook/support/managers/change-management/) to communicate changes to users.
  ...
  7. Post rollout retro 
     ...
     * Consider opening an issue/MR to automate parts of the rollout to make it safer and more efficient. Recommend to your manager that this work become part of an [Engineering Allocation](https://handbook.gitlab.com/handbook/product/product-processes/#prioritization-framework).


#### Additional rollout plan processes[](https://handbook.gitlab.com/handbook/engineering/workflow/development-processes/rollout-plans/#additional-rollout-plan-processes)
There are additional rollout plan processes to keep yourself aware of:
  * [Rolling out a low-risk feature flag](https://handbook.gitlab.com/handbook/product-development/how-we-work/product-development-flow/feature-flag-lifecycle/#rollout)
  * [Rolling out a high-risk feature flag](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/change-management/#feature-flags-and-the-change-management-process)
  * [Running an experiment](https://handbook.gitlab.com/handbook/engineering/development/growth/experimentation/#experiment-rollout-issue)


#### Rollout plan templates[](https://handbook.gitlab.com/handbook/engineering/workflow/development-processes/rollout-plans/#rollout-plan-templates)
...
### Examples of previous rollout plans[](https://handbook.gitlab.com/handbook/engineering/workflow/development-processes/rollout-plans/#examples-of-previous-rollout-plans)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/workflow/development-processes/rollout-plans.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/workflow/development-processes/rollout-plans.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)