...
## Communication[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#communication)
...
As part of a fully-distributed organization such as GitLab, it is important to stay informed about engineering-led initiatives. We employ [multimodal communication](https://handbook.gitlab.com/handbook/communication/#multimodal-communication), which describes the minimum set of communication channels we’ll broadcast to.
...
### GitLab Groups/Projects/MRs[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#gitlab-groupsprojectsmrs)
  ...
  * [**Start with a merge request**](https://handbook.gitlab.com/handbook/communication/#start-with-a-merge-request): The most effective way to make a change to the company is to make a proposal in the form of a merge request to the handbook and assign it to the [DRI](https://handbook.gitlab.com/handbook/people-group/directly-responsible-individuals/).


### Monitoring dashboards[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#monitoring-dashboards)
  * [**Monitoring dashboards**](https://handbook.gitlab.com/handbook/engineering/monitoring/): When we look to achieve a desired outcome, we must be able to quantify and measure progress towards that goal. By making the initial analysis that drives decision making repeatable, we continuously sanity check our initial assumptions along that journey.


### Synchronous meetings[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#synchronous-meetings)
  * [**Engineering All-Hands**](https://handbook.gitlab.com/handbook/engineering/cto-leadership-team/#engineering-all-hands).
  ...
  * **Principal+ Engineering Demo** : this call is an opportunity for sync discussions between Principal+ ICs across the Engineering Division to highlight current ongoing efforts underway in the groups they support. 
    * Focuses for the call include: 
      * Technical roadmap planning: dependencies, cross-departmental upstream requirements, opportunities for downstream improvements based on current projects. Future initiatives.
      * Opportunities for cross-department alignment, reuse of tooling, modules, processes, standards, technology, documentation.
      * Discussions on improving the career development resources for Engineering ICs at all levels
    * All team members are welcome to join the call, but the emphasis is on Principal+ ICs in the Engineering Division to present and discuss the work they’re focused on, the problems they’re experiencing, and solutions they’re considering.
...
### Asynchronous updates[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#asynchronous-updates)
#### Engineering Week-in-Review (EWIR) document[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#engineering-week-in-review-ewir-document)
...
#### Slack[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#slack)
##### #engineering-fyi[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#engineering-fyi)
...
##### Sending status updates to #engineering-fyi[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#sending-status-updates-to-engineering-fyi)
If you’d like to send status updates to [`#engineering-fyi`](https://gitlab.enterprise.slack.com/archives/CJWA4E9UG), please following the following process:
  ...
  2. In that issue, leave a “threaded” comment with a header `${Program} Status Update - YYYY-MM-DD` to make it clear that the status can be commented on
  3. Populate the content of this comment with the update corresponding to that date
  4. When you post to [`#engineering-fyi`](https://gitlab.enterprise.slack.com/archives/CJWA4E9UG) sharing this issue, please include 2-3 sentences that include the major updates on what was completed and what’s blocked or at risk. Please `@` tag relevant stakeholders as needed.
  5. If this update is the final update for the program, please close the issue after all relevant discussion has taken place.


##### DevOps Slack Channels[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#devops-slack-channels)
...
##### Other Slack channels that are Engineering focused and are good sources of information[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/#other-slack-channels-that-are-engineering-focused-and-are-good-sources-of-information)
...
* * *
#####  [Engineering Poster Boards](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-comms/engineering-poster-boards/)
Background At the FY25 GitLab Summit the Engineering Division held a poster session. This session …
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/workflow/engineering-comms/_index.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/workflow/engineering-comms/_index.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)