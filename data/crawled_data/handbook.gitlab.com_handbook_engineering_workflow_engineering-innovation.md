...
## Alignment with GitLab’s Strategy[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#alignment-with-gitlabs-strategy)
...
## Table of Contents[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#table-of-contents)
  1. [Overview](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#overview)
  2. [Internal vs External Innovations](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#internal-vs-external-innovations)
  3. [Process: Creating and Managing an Innovation](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#process-creating-and-managing-an-innovation)
  4. [Sharing Your Innovation](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#sharing-your-innovation)
  5. [Additional Resources](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#additional-resources)


## Overview[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#overview)
...
## Internal vs External Innovations[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#internal-vs-external-innovations)
...
Yes
No
What is my innovation/project?
Is it an external feature?
Work with Product and UX
Work with your engineering peers
Is the innovation accepted by Product and UX?
Create an experiment
Deprecate the innovation
Maintain as Internal
Upgrade to External / Experimental
Deprecate - not valuable

```

> **Note:** Consult your manager if you’re unsure which path your innovation should take.
### Internal Innovations[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#internal-innovations)
...
> **Note:** Internal innovations, or components of internal innovations, can sometimes evolve into external features when they demonstrate value that could benefit GitLab customers. In this case, DRIs should initiate collaboration with Product and UX teams and follow the [external innovation](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#external-innovations) process outlined in this guide.
### External Innovations[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#external-innovations)
...
## Process: Creating and Managing an Innovation[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#process-creating-and-managing-an-innovation)
## Step 1: Create a Proposal and Get Approval of Your Manager[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#step-1-create-a-proposal-and-get-approval-of-your-manager)
  1. Create a concise abstract that includes: 
    1. Your core idea and vision
    2. The specific problem you’re addressing
    3. The anticipated business value and impact with example use cases
    4. Key hypotheses you plan to validate in the timebox
    5. Timeboxed goals with clear targets
    6. Estimated time investment required
  2. Be sure to consult your manager before investing time into an idea. Your manager may surface that this work is not well-aligned or is a lower priority compared to other initiatives. Formalize your pitch in a SPIKE issue and obtain explicit manager approval before investing significant time, then work with your manager to identify optimal timing for this timeboxed exploration
  3. Consider any cost implications with the innovation, such as infrastructure cost, license cost, and maintenance cost to the best of your knowledge.
  4. Additionally, work with your Manager on identifying any other subject-matter-experts that may be attempting to solve the same problem.


### Step 2: Initiate an Epic[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#step-2-initiate-an-epic)
...
### Step 3: Start work on the POC and create the Associated Issues[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#step-3-start-work-on-the-poc-and-create-the-associated-issues)
...
### Step 4: Consider Confidentiality[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#step-4-consider-confidentiality)
  * **Public by Default:** In alignment with GitLab’s [Public by Default](https://handbook.gitlab.com/handbook/values/#public-by-default) value, innovations should be public from the start if possible. This promotes:
    * Enhanced trust and transparency with our community
    * Potential community collaboration opportunities
  * **Review Confidentiality Guidelines:** Before making your innovation public, review the [Confidentiality Levels](https://handbook.gitlab.com/handbook/communication/confidentiality-levels/#not-public) guidelines to determine if your innovation contains any sensitive information that should not be public, such as:
...
## Sharing Your Innovation[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#sharing-your-innovation)
...
Once you have gathered initial feedback and validated the potential of your innovation, these communication steps will help you share your innovation with the larger organization:
  1. **Get Internal Feedback:**
     * Get POC feedback from your Manager and Director+ in the Feedback issue created at [step 3](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#step-3-start-work-on-the-poc-and-create-the-associated-issues):
       * If your innovation is [external](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#external-innovations) facing, collect input from Product and UX peers.
       * If your innovation involves other product areas, lean into our [short toes](https://handbook.gitlab.com/handbook/values/#short-toes) value by involving the correct teams early on.
  ...
  4. **If Confidential, Transition The Epic to Public:**
     * In line with GitLab’s [Public by Default](https://handbook.gitlab.com/handbook/values/#public-by-default) value, work with the corresponding Product and UX team to make your innovation public as soon as possible once you’ve validated its potential. If your innovation contains potentially patentable information, work with your manager and the Legal Team to see if it meets [patent requirements](https://handbook.gitlab.com/handbook/legal/patent-program/#conditions-of-participation).
     * Ensure the transition aligns with GitLab’s Company Strategy and [Values](https://handbook.gitlab.com/handbook/values/), and collaborate with Product and UX when publicly communicating the innovation.


## Completing the Innovation process[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#completing-the-innovation-process)
...
## Additional Resources[](https://handbook.gitlab.com/handbook/engineering/workflow/engineering-innovation/#additional-resources)
  * **GitLab Engineering Handbook:** Refer to the [GitLab Engineering Handbook](https://handbook.gitlab.com/handbook/engineering/) for further context on engineering best practices and standards.
  * **GitLab Values:** Understand more about our core principles in the [GitLab Values](https://handbook.gitlab.com/handbook/values/) page.
  * **Architecture Design Workflow:** Architectural innovation usually follows our [Architecture Design Workflow](https://handbook.gitlab.com/handbook/engineering/architecture/workflow/)
...
[ ](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/engineering/workflow/engineering-innovation.md) - [ ](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/engineering/workflow/engineering-innovation.md) - please [contribute](https://handbook.gitlab.com/handbook/about/contributing/). [ ![Creative Commons License](https://i.creativecommons.org/l/by-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-sa/4.0/)